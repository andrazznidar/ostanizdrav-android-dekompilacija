...
.method public static final getUpdateInfo(Lcom/google/android/play/core/appupdate/AppUpdateManager;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    new-instance v0, Lde/rki/coronawarnapp/update/InAppUpdateKt$await$2$1;

    invoke-direct {v0, p1}, Lde/rki/coronawarnapp/update/InAppUpdateKt$await$2$1;-><init>(Lkotlinx/coroutines/CancellableContinuation;)V

    sget-object v2, Lcom/google/android/play/core/tasks/TaskExecutors;->MAIN_THREAD:Ljava/util/concurrent/Executor;

    invoke-virtual {p0, v2, v0}, Lcom/google/android/play/core/tasks/zzm;->addOnSuccessListener(Ljava/util/concurrent/Executor;Lcom/google/android/play/core/tasks/OnSuccessListener;)Lcom/google/android/play/core/tasks/zzm;

    new-instance v0, Lde/rki/coronawarnapp/update/InAppUpdateKt$await$2$2;

    invoke-direct {v0, p1}, Lde/rki/coronawarnapp/update/InAppUpdateKt$await$2$2;-><init>(Lkotlinx/coroutines/CancellableContinuation;)V

    invoke-virtual {p0, v2, v0}, Lcom/google/android/play/core/tasks/zzm;->addOnFailureListener(Ljava/util/concurrent/Executor;Lcom/google/android/play/core/tasks/OnFailureListener;)Lcom/google/android/play/core/tasks/zzm;
