.class public final Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x19
    name = "SubmissionTestResultAvailableFragmentSubcomponentImpl"
.end annotation
...
# direct methods
.method public constructor <init>(Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;Lde/rki/coronawarnapp/ui/submission/resultavailable/SubmissionTestResultAvailableFragment;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl-IA;)V
    .locals 7
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;->applicationComponent:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;

    iput-object p2, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;->mainActivitySubcomponentImpl:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;

    iget-object v1, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->tEKHistoryStorageProvider:Ljavax/inject/Provider;

    iget-object v2, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->timeStamperProvider:Ljavax/inject/Provider;

    iget-object v3, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->eNFClientProvider:Ljavax/inject/Provider;

    iget-object v4, p2, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;->factoryProvider10:Ljavax/inject/Provider;

    iget-object v5, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->appCoroutineScopeProvider:Ljavax/inject/Provider;

    new-instance p3, Lde/rki/coronawarnapp/submission/data/tekhistory/TEKHistoryUpdater_Factory;

    move-object v0, p3

    invoke-direct/range {v0 .. v5}, Lde/rki/coronawarnapp/submission/data/tekhistory/TEKHistoryUpdater_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    new-instance p4, Lde/rki/coronawarnapp/submission/data/tekhistory/TEKHistoryUpdater_Factory_Impl;

    invoke-direct {p4, p3}, Lde/rki/coronawarnapp/submission/data/tekhistory/TEKHistoryUpdater_Factory_Impl;-><init>(Lde/rki/coronawarnapp/submission/data/tekhistory/TEKHistoryUpdater_Factory;)V

    new-instance v2, Ldagger/internal/InstanceFactory;

    invoke-direct {v2, p4}, Ldagger/internal/InstanceFactory;-><init>(Ljava/lang/Object;)V

    iput-object v2, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    iget-object v3, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->submissionRepositoryProvider:Ljavax/inject/Provider;

    iget-object v4, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->checkInRepositoryProvider:Ljavax/inject/Provider;

    iget-object v5, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->autoSubmissionProvider:Ljavax/inject/Provider;

    iget-object v6, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->analyticsKeySubmissionCollectorProvider:Ljavax/inject/Provider;

    new-instance p1, Lde/rki/coronawarnapp/ui/submission/resultavailable/SubmissionTestResultAvailableViewModel_Factory;

    move-object v0, p1

    invoke-direct/range {v0 .. v6}, Lde/rki/coronawarnapp/ui/submission/resultavailable/SubmissionTestResultAvailableViewModel_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    new-instance p3, Lde/rki/coronawarnapp/ui/submission/resultavailable/SubmissionTestResultAvailableViewModel_Factory_Impl;

    invoke-direct {p3, p1}, Lde/rki/coronawarnapp/ui/submission/resultavailable/SubmissionTestResultAvailableViewModel_Factory_Impl;-><init>(Lde/rki/coronawarnapp/ui/submission/resultavailable/SubmissionTestResultAvailableViewModel_Factory;)V
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
    ...
    iget-object v4, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;->mapOfClassOfAndCWAViewModelFactoryOfProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;->factoryProvider3:Ljavax/inject/Provider;
...
.method public inject(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;->applicationComponent:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;
    ...
    iput-object v0, p1, Lde/rki/coronawarnapp/ui/submission/resultavailable/SubmissionTestResultAvailableFragment;->appShortcutsHelper:Lde/rki/coronawarnapp/util/shortcuts/AppShortcutsHelper;

    iget-object v0, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionTestResultAvailableFragmentSubcomponentImpl;->factoryProvider3:Ljavax/inject/Provider;
    ...
    iput-object v0, p1, Lde/rki/coronawarnapp/ui/submission/resultavailable/SubmissionTestResultAvailableFragment;->viewModelFactory:Lde/rki/coronawarnapp/util/viewmodel/CWAViewModelFactoryProvider$Factory;
