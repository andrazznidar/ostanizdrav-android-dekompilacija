.class public final Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionDeletionWarningFragmentSubcomponentImpl;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x19
    name = "SubmissionDeletionWarningFragmentSubcomponentImpl"
.end annotation
...
.field public testRegistrationStateProcessorProvider:Ljavax/inject/Provider;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljavax/inject/Provider<",
...
# direct methods
.method public constructor <init>(Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;Lde/rki/coronawarnapp/ui/submission/deletionwarning/SubmissionDeletionWarningFragment;Lorg/bouncycastle/crypto/util/OpenSSHPrivateKeyUtil$$ExternalSyntheticOutline0;)V
    .locals 6

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionDeletionWarningFragmentSubcomponentImpl;->applicationComponent:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;

    iput-object p2, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionDeletionWarningFragmentSubcomponentImpl;->mainActivitySubcomponentImpl:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;

    iget-object p3, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->submissionRepositoryProvider:Ljavax/inject/Provider;

    iget-object p4, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->analyticsKeySubmissionCollectorProvider:Ljavax/inject/Provider;

    new-instance v0, Lde/rki/coronawarnapp/submission/TestRegistrationStateProcessor_Factory;

    invoke-direct {v0, p3, p4}, Lde/rki/coronawarnapp/submission/TestRegistrationStateProcessor_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    iput-object v0, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionDeletionWarningFragmentSubcomponentImpl;->testRegistrationStateProcessorProvider:Ljavax/inject/Provider;

    iget-object p1, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->recycledCoronaTestsProvider:Ljavax/inject/Provider;

    new-instance p4, Lde/rki/coronawarnapp/ui/submission/deletionwarning/SubmissionDeletionWarningViewModel_Factory;

    invoke-direct {p4, v0, p1, p3}, Lde/rki/coronawarnapp/ui/submission/deletionwarning/SubmissionDeletionWarningViewModel_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    new-instance p1, Lde/rki/coronawarnapp/ui/submission/deletionwarning/SubmissionDeletionWarningViewModel_Factory_Impl;

    invoke-direct {p1, p4}, Lde/rki/coronawarnapp/ui/submission/deletionwarning/SubmissionDeletionWarningViewModel_Factory_Impl;-><init>(Lde/rki/coronawarnapp/ui/submission/deletionwarning/SubmissionDeletionWarningViewModel_Factory;)V
    ...
    iput-object p3, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionDeletionWarningFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    const-class v3, Lde/rki/coronawarnapp/ui/submission/deletionwarning/SubmissionDeletionWarningViewModel;

    iget-object v4, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionDeletionWarningFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionDeletionWarningFragmentSubcomponentImpl;->mapOfClassOfAndCWAViewModelFactoryOfProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionDeletionWarningFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
...
.method public inject(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$SubmissionDeletionWarningFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
    ...
    iput-object v0, p1, Lde/rki/coronawarnapp/ui/submission/deletionwarning/SubmissionDeletionWarningFragment;->viewModelFactory:Lde/rki/coronawarnapp/util/viewmodel/CWAViewModelFactoryProvider$Factory;
