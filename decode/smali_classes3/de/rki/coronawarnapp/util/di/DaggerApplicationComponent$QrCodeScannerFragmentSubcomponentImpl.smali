...
.method public constructor <init>(Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;Lde/rki/coronawarnapp/qrcode/ui/QrCodeScannerFragment;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl-IA;)V
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->applicationComponent:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;

    iput-object p2, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->mainActivitySubcomponentImpl:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;

    iget-object p3, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->appConfigProvider:Ljavax/inject/Provider;

    new-instance p4, Lde/rki/coronawarnapp/presencetracing/checkins/qrcode/CheckInQrCodeExtractor_Factory;

    invoke-direct {p4, p3}, Lde/rki/coronawarnapp/presencetracing/checkins/qrcode/CheckInQrCodeExtractor_Factory;-><init>(Ljavax/inject/Provider;)V

    invoke-static {p4}, Ldagger/internal/SingleCheck;->provider(Ljavax/inject/Provider;)Ljavax/inject/Provider;

    move-result-object p3

    iput-object p3, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->checkInQrCodeExtractorProvider:Ljavax/inject/Provider;

    iget-object p4, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->dccQrCodeExtractorProvider:Ljavax/inject/Provider;

    sget-object v0, Lde/rki/coronawarnapp/coronatest/qrcode/RapidAntigenQrCodeExtractor_Factory$InstanceHolder;->INSTANCE:Lde/rki/coronawarnapp/coronatest/qrcode/RapidAntigenQrCodeExtractor_Factory;

    sget-object v1, Lde/rki/coronawarnapp/coronatest/qrcode/PcrQrCodeExtractor_Factory$InstanceHolder;->INSTANCE:Lde/rki/coronawarnapp/coronatest/qrcode/PcrQrCodeExtractor_Factory;

    new-instance v2, Lde/rki/coronawarnapp/qrcode/scanner/QrCodeValidator_Factory;

    invoke-direct {v2, p4, v0, v1, p3}, Lde/rki/coronawarnapp/qrcode/scanner/QrCodeValidator_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    iput-object v2, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->qrCodeValidatorProvider:Ljavax/inject/Provider;

    iget-object p3, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->contextProvider:Ljavax/inject/Provider;

    iget-object p4, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->bindImageResolverProvider:Ljavax/inject/Provider;

    sget-object v0, Lde/rki/coronawarnapp/qrcode/provider/pdf/PdfUriResolver_Factory$InstanceHolder;->INSTANCE:Lde/rki/coronawarnapp/qrcode/provider/pdf/PdfUriResolver_Factory;

    new-instance v1, Lde/rki/coronawarnapp/qrcode/provider/QRCodeBitmapProvider_Factory;

    invoke-direct {v1, p3, p4, v0}, Lde/rki/coronawarnapp/qrcode/provider/QRCodeBitmapProvider_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    invoke-static {v1}, Ldagger/internal/SingleCheck;->provider(Ljavax/inject/Provider;)Ljavax/inject/Provider;

    move-result-object p3

    iput-object p3, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->qRCodeBitmapProvider:Ljavax/inject/Provider;
    ...
    iget-object v0, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->qrCodeReaderProvider:Ljavax/inject/Provider;

    new-instance v1, Lde/rki/coronawarnapp/qrcode/QrCodeFileParser_Factory;

    invoke-direct {v1, p4, p3, v0}, Lde/rki/coronawarnapp/qrcode/QrCodeFileParser_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    invoke-static {v1}, Ldagger/internal/SingleCheck;->provider(Ljavax/inject/Provider;)Ljavax/inject/Provider;

    move-result-object p3

    iput-object p3, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->qrCodeFileParserProvider:Ljavax/inject/Provider;

    iget-object p3, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->vaccinationRepositoryProvider:Ljavax/inject/Provider;

    iget-object p4, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->testCertificateRepositoryProvider:Ljavax/inject/Provider;

    iget-object v0, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->recoveryCertificateRepositoryProvider:Ljavax/inject/Provider;

    iget-object v1, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->dscSignatureValidatorProvider:Ljavax/inject/Provider;

    new-instance v2, Lde/rki/coronawarnapp/qrcode/handler/DccQrCodeHandler_Factory;

    invoke-direct {v2, p3, p4, v0, v1}, Lde/rki/coronawarnapp/qrcode/handler/DccQrCodeHandler_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    iput-object v2, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->dccQrCodeHandlerProvider:Ljavax/inject/Provider;

    sget-object p3, Lde/rki/coronawarnapp/qrcode/handler/CheckInQrCodeHandler_Factory$InstanceHolder;->INSTANCE:Lde/rki/coronawarnapp/qrcode/handler/CheckInQrCodeHandler_Factory;

    invoke-static {p3}, Ldagger/internal/SingleCheck;->provider(Ljavax/inject/Provider;)Ljavax/inject/Provider;

    move-result-object v6

    iput-object v6, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->checkInQrCodeHandlerProvider:Ljavax/inject/Provider;
    ...
    iget-object v2, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->cameraSettingsProvider:Ljavax/inject/Provider;

    iget-object v3, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->qrCodeValidatorProvider:Ljavax/inject/Provider;

    iget-object v4, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->qrCodeFileParserProvider:Ljavax/inject/Provider;

    iget-object v5, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->dccQrCodeHandlerProvider:Ljavax/inject/Provider;

    iget-object v7, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->submissionRepositoryProvider:Ljavax/inject/Provider;

    iget-object v8, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->covidCertificateSettingsProvider:Ljavax/inject/Provider;

    iget-object v9, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->traceLocationSettingsProvider:Ljavax/inject/Provider;

    new-instance p1, Lde/rki/coronawarnapp/qrcode/ui/QrCodeScannerViewModel_Factory;

    move-object v0, p1

    invoke-direct/range {v0 .. v9}, Lde/rki/coronawarnapp/qrcode/ui/QrCodeScannerViewModel_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    new-instance p3, Lde/rki/coronawarnapp/qrcode/ui/QrCodeScannerViewModel_Factory_Impl;

    invoke-direct {p3, p1}, Lde/rki/coronawarnapp/qrcode/ui/QrCodeScannerViewModel_Factory_Impl;-><init>(Lde/rki/coronawarnapp/qrcode/ui/QrCodeScannerViewModel_Factory;)V

    new-instance p1, Ldagger/internal/InstanceFactory;

    invoke-direct {p1, p3}, Ldagger/internal/InstanceFactory;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    const-class v3, Lde/rki/coronawarnapp/qrcode/ui/QrCodeScannerViewModel;

    iget-object v4, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->mapOfClassOfAndCWAViewModelFactoryOfProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodeScannerFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
