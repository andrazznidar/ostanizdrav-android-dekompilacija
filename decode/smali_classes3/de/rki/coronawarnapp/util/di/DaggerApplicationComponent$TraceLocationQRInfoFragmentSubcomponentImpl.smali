.class public final Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x19
    name = "TraceLocationQRInfoFragmentSubcomponentImpl"
.end annotation
...
# direct methods
.method public constructor <init>(Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;Lde/rki/coronawarnapp/ui/presencetracing/organizer/qrinfo/TraceLocationQRInfoFragment;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl-IA;)V
    .locals 6

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl;->applicationComponent:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;

    iput-object p2, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl;->mainActivitySubcomponentImpl:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;

    new-instance p1, Lde/rki/coronawarnapp/ui/presencetracing/organizer/qrinfo/TraceLocationQRInfoViewModel_Factory;

    invoke-direct {p1}, Lde/rki/coronawarnapp/ui/presencetracing/organizer/qrinfo/TraceLocationQRInfoViewModel_Factory;-><init>()V

    new-instance p3, Lde/rki/coronawarnapp/ui/presencetracing/organizer/qrinfo/TraceLocationQRInfoViewModel_Factory_Impl;

    invoke-direct {p3, p1}, Lde/rki/coronawarnapp/ui/presencetracing/organizer/qrinfo/TraceLocationQRInfoViewModel_Factory_Impl;-><init>(Lde/rki/coronawarnapp/ui/presencetracing/organizer/qrinfo/TraceLocationQRInfoViewModel_Factory;)V
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    const-class v3, Lde/rki/coronawarnapp/ui/presencetracing/organizer/qrinfo/TraceLocationQRInfoViewModel;

    iget-object v4, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl;->mapOfClassOfAndCWAViewModelFactoryOfProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
...
.method public inject(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl;->applicationComponent:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;

    iget-object v0, v0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->traceLocationOrganizerSettingsProvider:Ljavax/inject/Provider;

    invoke-interface {v0}, Ljavax/inject/Provider;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lde/rki/coronawarnapp/ui/presencetracing/organizer/TraceLocationOrganizerSettings;

    iput-object v0, p1, Lde/rki/coronawarnapp/ui/presencetracing/organizer/qrinfo/TraceLocationQRInfoFragment;->settings:Lde/rki/coronawarnapp/ui/presencetracing/organizer/TraceLocationOrganizerSettings;

    iget-object v0, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$TraceLocationQRInfoFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
    ...
    iput-object v0, p1, Lde/rki/coronawarnapp/ui/presencetracing/organizer/qrinfo/TraceLocationQRInfoFragment;->viewModelFactory:Lde/rki/coronawarnapp/util/viewmodel/CWAViewModelFactoryProvider$Factory;
