.class public final Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x19
    name = "PersonOverviewFragmentSubcomponentImpl"
.end annotation
...
.field public cCLTextFormatterProvider:Ljavax/inject/Provider;
...
# direct methods
.method public constructor <init>(Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;Lde/rki/coronawarnapp/covidcertificate/person/ui/overview/PersonOverviewFragment;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl-IA;)V
    .locals 8

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl;->applicationComponent:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;

    iput-object p2, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl;->mainActivitySubcomponentImpl:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;

    iget-object p3, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->cCLJsonFunctionsProvider:Ljavax/inject/Provider;

    iget-object p4, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->jacksonObjectMapperProvider:Ljavax/inject/Provider;

    new-instance v0, Lde/rki/coronawarnapp/ccl/ui/text/CCLTextFormatter_Factory;

    invoke-direct {v0, p3, p4}, Lde/rki/coronawarnapp/ccl/ui/text/CCLTextFormatter_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    invoke-static {v0}, Ldagger/internal/SingleCheck;->provider(Ljavax/inject/Provider;)Ljavax/inject/Provider;

    move-result-object v7

    iput-object v7, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl;->cCLTextFormatterProvider:Ljavax/inject/Provider;
    ...
    iget-object v3, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->personCertificatesProvider:Ljavax/inject/Provider;

    iget-object v4, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->testCertificateRepositoryProvider:Ljavax/inject/Provider;
    ...
    iget-object v6, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->dccExpirationNotificationServiceProvider:Ljavax/inject/Provider;

    new-instance p1, Lde/rki/coronawarnapp/covidcertificate/person/ui/overview/PersonOverviewViewModel_Factory;

    move-object v1, p1

    invoke-direct/range {v1 .. v7}, Lde/rki/coronawarnapp/covidcertificate/person/ui/overview/PersonOverviewViewModel_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    new-instance p3, Lde/rki/coronawarnapp/covidcertificate/person/ui/overview/PersonOverviewViewModel_Factory_Impl;

    invoke-direct {p3, p1}, Lde/rki/coronawarnapp/covidcertificate/person/ui/overview/PersonOverviewViewModel_Factory_Impl;-><init>(Lde/rki/coronawarnapp/covidcertificate/person/ui/overview/PersonOverviewViewModel_Factory;)V
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    const-class v3, Lde/rki/coronawarnapp/covidcertificate/person/ui/overview/PersonOverviewViewModel;

    iget-object v4, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl;->mapOfClassOfAndCWAViewModelFactoryOfProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
...
.method public inject(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$PersonOverviewFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
    ...
    iput-object v0, p1, Lde/rki/coronawarnapp/covidcertificate/person/ui/overview/PersonOverviewFragment;->viewModelFactory:Lde/rki/coronawarnapp/util/viewmodel/CWAViewModelFactoryProvider$Factory;
