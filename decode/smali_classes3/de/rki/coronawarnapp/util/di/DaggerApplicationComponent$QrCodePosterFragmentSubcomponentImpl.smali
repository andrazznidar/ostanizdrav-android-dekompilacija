.class public final Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x19
    name = "QrCodePosterFragmentSubcomponentImpl"
.end annotation
...
.field public posterTemplateProvider:Ljavax/inject/Provider;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljavax/inject/Provider<",
...
# direct methods
.method public constructor <init>(Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterFragment;Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl-IA;)V
    .locals 8
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->applicationComponent:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;

    iput-object p2, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->mainActivitySubcomponentImpl:Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$MainActivitySubcomponentImpl;

    iget-object p3, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->qrCodePosterTemplateServerProvider:Ljavax/inject/Provider;
    ...
    iget-object v0, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->contextProvider:Ljavax/inject/Provider;

    new-instance v1, Lde/rki/coronawarnapp/presencetracing/checkins/qrcode/PosterTemplateProvider_Factory;

    invoke-direct {v1, p3, p4, v0}, Lde/rki/coronawarnapp/presencetracing/checkins/qrcode/PosterTemplateProvider_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    iput-object v1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->posterTemplateProvider:Ljavax/inject/Provider;

    new-instance p3, Lde/rki/coronawarnapp/util/files/FileSharing_Factory;

    invoke-direct {p3, v0}, Lde/rki/coronawarnapp/util/files/FileSharing_Factory;-><init>(Ljavax/inject/Provider;)V

    invoke-static {p3}, Ldagger/internal/SingleCheck;->provider(Ljavax/inject/Provider;)Ljavax/inject/Provider;

    move-result-object v6

    iput-object v6, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->fileSharingProvider:Ljavax/inject/Provider;

    iget-object v2, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->defaultDispatcherProvider:Ljavax/inject/Provider;

    iget-object v3, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->posterTemplateProvider:Ljavax/inject/Provider;

    iget-object v4, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->defaultTraceLocationRepositoryProvider:Ljavax/inject/Provider;

    iget-object v5, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->appConfigProvider:Ljavax/inject/Provider;

    iget-object v7, p1, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent;->contextProvider:Ljavax/inject/Provider;

    new-instance p1, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel_Factory;

    move-object v1, p1

    invoke-direct/range {v1 .. v7}, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    new-instance p3, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel_Factory_Impl;

    invoke-direct {p3, p1}, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel_Factory_Impl;-><init>(Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel_Factory;)V
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    iget-object v4, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->factoryProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->mapOfClassOfAndCWAViewModelFactoryOfProvider:Ljavax/inject/Provider;
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
...
.method public inject(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lde/rki/coronawarnapp/util/di/DaggerApplicationComponent$QrCodePosterFragmentSubcomponentImpl;->factoryProvider2:Ljavax/inject/Provider;
    ...
    iput-object v0, p1, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterFragment;->viewModelFactory:Lde/rki/coronawarnapp/util/viewmodel/CWAViewModelFactoryProvider$Factory;
