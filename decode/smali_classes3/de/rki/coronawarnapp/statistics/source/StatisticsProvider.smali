...
.method public static final access$fromCache(Lde/rki/coronawarnapp/statistics/source/StatisticsProvider;)Lde/rki/coronawarnapp/statistics/StatisticsData;
    ...
    const-string v5, "Parsed from cache: %s"
    ...
    iget-boolean v5, p0, Lde/rki/coronawarnapp/statistics/StatisticsData;->isDataAvailable:Z

    if-nez v5, :cond_2

    invoke-virtual {v4, v0}, Ltimber/log/Timber$Forest;->tag(Ljava/lang/String;)Ltimber/log/Timber$Tree;

    const-string v5, "RawData: %s"

    new-array v7, v6, [Ljava/lang/Object;

    sget-object v8, Lde/rki/coronawarnapp/util/HashExtensions;->INSTANCE:Lde/rki/coronawarnapp/util/HashExtensions;

    invoke-virtual {v8, v3, v6}, Lde/rki/coronawarnapp/util/HashExtensions;->formatHash$enumunboxing$([BI)Ljava/lang/String;

    move-result-object v3

    aput-object v3, v7, v2

    invoke-virtual {v4, v5, v7}, Ltimber/log/Timber$Forest;->w(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_2
...
.method public static final access$fromServer(Lde/rki/coronawarnapp/statistics/source/StatisticsProvider;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v6, v2}, Ltimber/log/Timber$Forest;->d(Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v2, v1, Lde/rki/coronawarnapp/statistics/StatisticsData;->isDataAvailable:Z
    ...
    sget-object v4, Lde/rki/coronawarnapp/util/HashExtensions;->INSTANCE:Lde/rki/coronawarnapp/util/HashExtensions;

    invoke-virtual {v4, p1, v5}, Lde/rki/coronawarnapp/util/HashExtensions;->formatHash$enumunboxing$([BI)Ljava/lang/String;

    move-result-object v4

    aput-object v4, v2, v3

    const-string v3, "RawData: %s"
