...
.method public add(Lorg/bouncycastle/math/ec/ECPoint;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-static {v8, v13}, Lcoil/memory/EmptyStrongMemoryCache;->square([I[I)V

    iget-object v5, v5, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v13, v5, v12}, Lcoil/memory/EmptyStrongMemoryCache;->multiply([I[I[I)V

    iget-object v5, v7, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v13, v5, v13}, Lcoil/memory/EmptyStrongMemoryCache;->multiply([I[I[I)V
    ...
    :cond_4
    iget-object v9, v1, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v9, v14}, Lcoil/memory/EmptyStrongMemoryCache;->square([I[I)V

    iget-object v3, v3, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v14, v3, v10}, Lcoil/memory/EmptyStrongMemoryCache;->multiply([I[I[I)V

    iget-object v3, v1, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v14, v3, v14}, Lcoil/memory/EmptyStrongMemoryCache;->multiply([I[I[I)V
    ...
    invoke-static {v3, v5, v9}, Lcoil/memory/EmptyStrongMemoryCache;->subtract([I[I[I)V

    invoke-static {v4, v6, v12}, Lcoil/memory/EmptyStrongMemoryCache;->subtract([I[I[I)V
    ...
    invoke-static {v6, v13}, Lcoil/memory/EmptyStrongMemoryCache;->reduce([I[I)V
    ...
    invoke-static {v11, v6}, Lcoil/memory/EmptyStrongMemoryCache;->reduce([I[I)V

    new-array v11, v5, [I

    invoke-static {v13, v3, v11}, Lorg/bouncycastle/util/Pack;->mul$4([I[I[I)V

    invoke-static {v11, v13}, Lcoil/memory/EmptyStrongMemoryCache;->reduce([I[I)V

    invoke-static {v6}, Lcoil/memory/EmptyStrongMemoryCache;->isZero([I)I

    move-result v3

    if-eqz v3, :cond_7

    sget-object v3, Lcoil/memory/EmptyStrongMemoryCache;->P:[I
    ...
    invoke-static {v3, v6}, Lcoil/memory/EmptyStrongMemoryCache;->reduce32(I[I)V

    new-instance v3, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;

    invoke-direct {v3, v14}, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;-><init>([I)V
    ...
    invoke-static {v5, v14}, Lcoil/memory/EmptyStrongMemoryCache;->reduce([I[I)V

    iget-object v4, v3, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v4, v6, v4}, Lcoil/memory/EmptyStrongMemoryCache;->subtract([I[I[I)V
    ...
    invoke-static {v13, v5, v6}, Lorg/bouncycastle/util/Pack;->sub$4([I[I[I)I
    ...
    sget-object v5, Lcoil/memory/EmptyStrongMemoryCache;->PExt:[I
    ...
    :goto_3
    sget-object v5, Lcoil/memory/EmptyStrongMemoryCache;->PExtInv:[I
    ...
    invoke-static {v10, v5}, Lcoil/memory/EmptyStrongMemoryCache;->reduce([I[I)V
    ...
    invoke-static {v9, v6, v9}, Lcoil/memory/EmptyStrongMemoryCache;->multiply([I[I[I)V
    ...
    invoke-static {v6, v1, v6}, Lcoil/memory/EmptyStrongMemoryCache;->multiply([I[I[I)V
...
.method public twice()Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-static {v7, v6}, Lcoil/memory/EmptyStrongMemoryCache;->square([I[I)V
    ...
    invoke-static {v6, v9}, Lorg/bouncycastle/util/Pack;->square$4([I[I)V

    invoke-static {v9, v7}, Lcoil/memory/EmptyStrongMemoryCache;->reduce([I[I)V

    new-array v9, v5, [I

    iget-object v10, v2, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v10, v9}, Lcoil/memory/EmptyStrongMemoryCache;->square([I[I)V

    invoke-static {v9, v9, v9}, Lorg/bouncycastle/util/Pack;->addBothTo$4([I[I[I)I

    move-result v10

    invoke-static {v10, v9}, Lcoil/memory/EmptyStrongMemoryCache;->reduce32(I[I)V

    iget-object v2, v2, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v6, v2, v6}, Lcoil/memory/EmptyStrongMemoryCache;->multiply([I[I[I)V
    ...
    invoke-static {v2, v6}, Lcoil/memory/EmptyStrongMemoryCache;->reduce32(I[I)V
    ...
    invoke-static {v10, v2}, Lcoil/memory/EmptyStrongMemoryCache;->reduce32(I[I)V

    new-instance v10, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;

    invoke-direct {v10, v7}, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;-><init>([I)V

    new-array v11, v8, [I

    invoke-static {v9, v11}, Lorg/bouncycastle/util/Pack;->square$4([I[I)V

    invoke-static {v11, v7}, Lcoil/memory/EmptyStrongMemoryCache;->reduce([I[I)V

    iget-object v7, v10, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v7, v6, v7}, Lcoil/memory/EmptyStrongMemoryCache;->subtract([I[I[I)V
    ...
    iget-object v11, v10, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v6, v11, v6}, Lorg/bouncycastle/util/Pack;->sub$4([I[I[I)I
    ...
    invoke-static {v6, v9, v8}, Lorg/bouncycastle/util/Pack;->mul$4([I[I[I)V

    invoke-static {v8, v6}, Lcoil/memory/EmptyStrongMemoryCache;->reduce([I[I)V

    iget-object v6, v7, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;->x:[I

    invoke-static {v6, v2, v6}, Lcoil/memory/EmptyStrongMemoryCache;->subtract([I[I[I)V

    new-instance v2, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;

    invoke-direct {v2, v9}, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1FieldElement;-><init>([I)V
    ...
    sget-object v1, Lcoil/memory/EmptyStrongMemoryCache;->P:[I

    invoke-static {v9, v1}, Lorg/bouncycastle/util/Pack;->gte$4([I[I)Z
    ...
    invoke-static {v1, v3, v1}, Lcoil/memory/EmptyStrongMemoryCache;->multiply([I[I[I)V
    ...
    invoke-direct {v1, v0, v10, v7, v3}, Lorg/bouncycastle/math/ec/custom/sec/SecP256K1Point;-><init>(Lorg/bouncycastle/math/ec/ECCurve;Lorg/bouncycastle/math/ec/ECFieldElement;Lorg/bouncycastle/math/ec/ECFieldElement;[Lorg/bouncycastle/math/ec/ECFieldElement;)V
