...
.method private static createBaseRandom(Z)Ljava/security/SecureRandom;
    ...
    invoke-interface {v0, v2}, Lorg/bouncycastle/crypto/prng/EntropySourceProvider;->get(I)Lorg/bouncycastle/crypto/prng/EntropySource;
    ...
    invoke-static {v6, v2}, Lorg/bouncycastle/util/Arrays;->concatenate([B[B)[B
    ...
    new-instance v7, Lorg/bouncycastle/crypto/prng/SP800SecureRandomBuilder$HashDRBGProvider;

    invoke-direct {v7, v5, v2, v3, v1}, Lorg/bouncycastle/crypto/prng/SP800SecureRandomBuilder$HashDRBGProvider;-><init>(Lorg/bouncycastle/crypto/Digest;[B[BI)V

    invoke-direct {v6, v4, v0, v7, p0}, Lorg/bouncycastle/crypto/prng/SP800SecureRandom;-><init>(Ljava/security/SecureRandom;Lorg/bouncycastle/crypto/prng/EntropySource;Lorg/bouncycastle/crypto/prng/DRBGProvider;Z)V
    ...
    new-instance v4, Lorg/bouncycastle/crypto/prng/BasicEntropySourceProvider;

    invoke-direct {v4, v0, v3}, Lorg/bouncycastle/crypto/prng/BasicEntropySourceProvider;-><init>(Ljava/security/SecureRandom;Z)V
    ...
    new-instance v7, Lorg/bouncycastle/crypto/prng/BasicEntropySourceProvider$1;

    invoke-direct {v7, v4, v1}, Lorg/bouncycastle/crypto/prng/BasicEntropySourceProvider$1;-><init>(Lorg/bouncycastle/crypto/prng/BasicEntropySourceProvider;I)V

    new-instance v4, Lorg/bouncycastle/crypto/prng/SP800SecureRandomBuilder$HashDRBGProvider;

    invoke-direct {v4, v3, v5, v2, v1}, Lorg/bouncycastle/crypto/prng/SP800SecureRandomBuilder$HashDRBGProvider;-><init>(Lorg/bouncycastle/crypto/Digest;[B[BI)V

    invoke-direct {v6, v0, v7, v4, p0}, Lorg/bouncycastle/crypto/prng/SP800SecureRandom;-><init>(Ljava/security/SecureRandom;Lorg/bouncycastle/crypto/prng/EntropySource;Lorg/bouncycastle/crypto/prng/DRBGProvider;Z)V
...
.method private static generateDefaultPersonalizationString([B)[B
    ...
    invoke-static {v1, v2, v4, v5}, Lorg/bouncycastle/util/Pack;->longToBigEndian(J[BI)V
    ...
    invoke-static {v0, p0, v4, v3}, Lorg/bouncycastle/util/Arrays;->concatenate([B[B[B[B)[B
