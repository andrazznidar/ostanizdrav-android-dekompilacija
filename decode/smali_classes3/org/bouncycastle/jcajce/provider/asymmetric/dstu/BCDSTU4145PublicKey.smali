...
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;Lorg/bouncycastle/jce/spec/ECParameterSpec;)V
    ...
    iget-object v0, p3, Lorg/bouncycastle/jce/spec/ECParameterSpec;->seed:[B
...
.method public constructor <init>(Lorg/bouncycastle/jce/spec/ECPublicKeySpec;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    ...
    iget-object v0, p1, Lorg/bouncycastle/jce/spec/ECKeySpec;->spec:Lorg/bouncycastle/jce/spec/ECParameterSpec;

    if-eqz v0, :cond_0

    iget-object v1, v0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->curve:Lorg/bouncycastle/math/ec/ECCurve;

    iget-object v0, v0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->seed:[B

    invoke-static {v1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertCurve(Lorg/bouncycastle/math/ec/ECCurve;[B)Ljava/security/spec/EllipticCurve;

    move-result-object v0

    new-instance v1, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;

    iget-object v2, p1, Lorg/bouncycastle/jce/spec/ECPublicKeySpec;->q:Lorg/bouncycastle/math/ec/ECPoint;

    iget-object v3, p1, Lorg/bouncycastle/jce/spec/ECKeySpec;->spec:Lorg/bouncycastle/jce/spec/ECParameterSpec;
    ...
    iget-object p1, p1, Lorg/bouncycastle/jce/spec/ECKeySpec;->spec:Lorg/bouncycastle/jce/spec/ECParameterSpec;
    ...
    iget-object p1, p1, Lorg/bouncycastle/jce/spec/ECPublicKeySpec;->q:Lorg/bouncycastle/math/ec/ECPoint;
...
.method private createSpec(Ljava/security/spec/EllipticCurve;Lorg/bouncycastle/crypto/params/ECDomainParameters;)Ljava/security/spec/ECParameterSpec;
    ...
    iget-object v1, p2, Lorg/bouncycastle/crypto/params/ECDomainParameters;->G:Lorg/bouncycastle/math/ec/ECPoint;
    ...
    iget-object v2, p2, Lorg/bouncycastle/crypto/params/ECDomainParameters;->n:Ljava/math/BigInteger;

    iget-object p2, p2, Lorg/bouncycastle/crypto/params/ECDomainParameters;->h:Ljava/math/BigInteger;
...
.method private populateFromPubKeyInfo(Lorg/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)V
    ...
    iget-object v7, v1, Lorg/bouncycastle/crypto/params/ECDomainParameters;->curve:Lorg/bouncycastle/math/ec/ECCurve;

    iget-object v8, v1, Lorg/bouncycastle/crypto/params/ECDomainParameters;->G:Lorg/bouncycastle/math/ec/ECPoint;

    iget-object v9, v1, Lorg/bouncycastle/crypto/params/ECDomainParameters;->n:Ljava/math/BigInteger;

    iget-object v10, v1, Lorg/bouncycastle/crypto/params/ECDomainParameters;->h:Ljava/math/BigInteger;
    ...
    :goto_1
    iget-object v2, v1, Lorg/bouncycastle/jce/spec/ECParameterSpec;->curve:Lorg/bouncycastle/math/ec/ECCurve;

    iget-object v3, v1, Lorg/bouncycastle/jce/spec/ECParameterSpec;->seed:[B
    ...
    iget-object p1, v1, Lorg/bouncycastle/jce/spec/ECParameterSpec;->G:Lorg/bouncycastle/math/ec/ECPoint;
    ...
    iget-object v9, v1, Lorg/bouncycastle/jce/spec/ECParameterSpec;->n:Ljava/math/BigInteger;

    iget-object v10, v1, Lorg/bouncycastle/jce/spec/ECParameterSpec;->h:Ljava/math/BigInteger;
    ...
    iget-object v3, v1, Lorg/bouncycastle/jce/spec/ECParameterSpec;->n:Ljava/math/BigInteger;

    iget-object v1, v1, Lorg/bouncycastle/jce/spec/ECParameterSpec;->h:Ljava/math/BigInteger;
...
.method public getEncoded()[B
    ...
    iget-object v2, v2, Lorg/bouncycastle/jce/spec/ECNamedCurveSpec;->name:Ljava/lang/String;
