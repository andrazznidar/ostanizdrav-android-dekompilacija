...
.method public engineGenerateParameters()Ljava/security/AlgorithmParameters;
    ...
    iput v4, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->size:I

    iput v3, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->typeproc:I

    iput-object v2, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->init_random:Ljava/security/SecureRandom;
    ...
    iput v2, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->size:I

    iput v3, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->typeproc:I

    iput-object v4, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->init_random:Ljava/security/SecureRandom;

    :goto_0
    new-array v9, v3, [Ljava/math/BigInteger;

    iget v2, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->typeproc:I
    ...
    iget-object v6, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->init_random:Ljava/security/SecureRandom;

    invoke-virtual {v6}, Ljava/security/SecureRandom;->nextInt()I

    move-result v6

    iget v7, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->size:I
    ...
    invoke-direct {v8, v14}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;)V

    const/16 v14, 0x100

    invoke-virtual {v0, v4, v15, v3, v14}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_A(II[Ljava/math/BigInteger;I)I

    move-result v4

    aget-object v14, v3, v13

    invoke-virtual {v0, v4, v15, v3, v5}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_A(II[Ljava/math/BigInteger;I)I
    ...
    invoke-virtual {v7, v1, v4}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    :cond_b
    invoke-virtual {v0, v2, v6, v9, v5}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_A(II[Ljava/math/BigInteger;I)I
    ...
    invoke-virtual {v0, v1, v3}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_C(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v5, v2, v6}, Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;-><init>(II)V

    invoke-direct {v4, v1, v3, v0, v5}, Lorg/bouncycastle/crypto/params/GOST3410Parameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;)V
    ...
    iget v1, v0, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->size:I
    ...
    invoke-virtual/range {v2 .. v8}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_Aa(JJ[Ljava/math/BigInteger;I)J
    ...
    invoke-virtual {v0, v1, v2}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_C(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v3, v11, v12, v5, v6}, Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;-><init>(JJ)V

    invoke-direct {v4, v1, v2, v0, v3}, Lorg/bouncycastle/crypto/params/GOST3410Parameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;)V
    ...
    iget-object v5, v4, Lorg/bouncycastle/crypto/params/GOST3410Parameters;->p:Ljava/math/BigInteger;

    iget-object v6, v4, Lorg/bouncycastle/crypto/params/GOST3410Parameters;->q:Ljava/math/BigInteger;

    iget-object v4, v4, Lorg/bouncycastle/crypto/params/GOST3410Parameters;->a:Ljava/math/BigInteger;

    invoke-direct {v3, v5, v6, v4}, Lorg/bouncycastle/jce/spec/GOST3410PublicKeyParameterSetSpec;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
