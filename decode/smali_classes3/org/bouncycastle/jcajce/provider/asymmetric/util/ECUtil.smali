...
.method public static generateKeyFingerprint(Lorg/bouncycastle/math/ec/ECPoint;Lorg/bouncycastle/jce/spec/ECParameterSpec;)Ljava/lang/String;
    ...
    invoke-static {p0, v6, v0, p1}, Lorg/bouncycastle/util/Arrays;->concatenate([B[B[B[B)[B
    ...
    invoke-direct {p1, v2}, Lorg/bouncycastle/crypto/digests/SHAKEDigest;-><init>(I)V

    array-length v0, p0

    invoke-virtual {p1, p0, v5, v0}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->absorb([BII)V

    div-int/lit8 v4, v4, 0x8

    new-array p0, v4, [B

    invoke-virtual {p1, p0, v5, v4}, Lorg/bouncycastle/crypto/digests/SHAKEDigest;->doOutput([BII)I
...
.method public static generatePrivateKeyParameter(Ljava/security/PrivateKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    iget-object v1, v1, Lorg/bouncycastle/jce/spec/ECNamedCurveParameterSpec;->name:Ljava/lang/String;
    ...
    iget-object v5, v0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->curve:Lorg/bouncycastle/math/ec/ECCurve;

    iget-object v6, v0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->G:Lorg/bouncycastle/math/ec/ECPoint;

    iget-object v7, v0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->n:Ljava/math/BigInteger;

    iget-object v8, v0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->h:Ljava/math/BigInteger;

    iget-object v9, v0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->seed:[B
    ...
    iget-object v6, v0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->h:Ljava/math/BigInteger;

    iget-object v7, v0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->seed:[B
...
.method public static getNamedCurveOid(Lorg/bouncycastle/jce/spec/ECParameterSpec;)Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->n:Ljava/math/BigInteger;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->curve:Lorg/bouncycastle/math/ec/ECCurve;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jce/spec/ECParameterSpec;->G:Lorg/bouncycastle/math/ec/ECPoint;
...
.method public static privateKeyToString(Ljava/lang/String;Ljava/math/BigInteger;Lorg/bouncycastle/jce/spec/ECParameterSpec;)Ljava/lang/String;
    ...
    iget-object v3, p2, Lorg/bouncycastle/jce/spec/ECParameterSpec;->G:Lorg/bouncycastle/math/ec/ECPoint;

    invoke-virtual {v2, v3, p1}, Lorg/joda/time/Chronology;->multiply(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
