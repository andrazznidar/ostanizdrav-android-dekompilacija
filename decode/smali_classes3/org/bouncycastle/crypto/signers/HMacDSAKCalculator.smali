...
# virtual methods
.method public final bitsToInt([B)Ljava/math/BigInteger;
    .locals 3
...
.method public init(Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V
    ...
    invoke-virtual {p0, p3}, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->bitsToInt([B)Ljava/math/BigInteger;
    ...
    iget-object p1, p1, Lorg/bouncycastle/crypto/macs/HMac;->digest:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {p1, p3, v2, v4}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {p1, v3, v2, v0}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
...
.method public nextK()Ljava/math/BigInteger;
    ...
    iget-object v4, v4, Lorg/bouncycastle/crypto/macs/HMac;->digest:Lorg/bouncycastle/crypto/Digest;
    ...
    :cond_0
    invoke-virtual {p0, v1}, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->bitsToInt([B)Ljava/math/BigInteger;
    ...
    iget-object v3, v3, Lorg/bouncycastle/crypto/macs/HMac;->digest:Lorg/bouncycastle/crypto/Digest;
    ...
    invoke-interface {v3, v2}, Lorg/bouncycastle/crypto/Digest;->update(B)V
