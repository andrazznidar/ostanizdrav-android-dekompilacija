...
.method public final getOutputLFSR()I
    .locals 8
...
.method public final getOutputNFSR()I
    .locals 22
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->workingIV:[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->workingKey:[B
...
.method public processBytes([BII[BI)I
    ...
    iget v4, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->index:I

    const/4 v5, 0x3

    if-le v4, v5, :cond_0

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/engines/Grain128Engine;->getOutput()I

    move-result v4

    iput v4, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->output:I

    iget-object v6, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->out:[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->nfsr:[I

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/engines/Grain128Engine;->getOutputNFSR()I

    move-result v5

    iget-object v6, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->lfsr:[I

    aget v6, v6, v0

    xor-int/2addr v5, v6

    invoke-virtual {p0, v4, v5}, Lorg/bouncycastle/crypto/engines/Grain128Engine;->shift([II)[I

    iput-object v4, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->nfsr:[I

    iget-object v4, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->lfsr:[I

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/engines/Grain128Engine;->getOutputLFSR()I

    move-result v5

    invoke-virtual {p0, v4, v5}, Lorg/bouncycastle/crypto/engines/Grain128Engine;->shift([II)[I

    iput-object v4, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->lfsr:[I

    iput v0, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->index:I

    :cond_0
    iget-object v4, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->out:[B

    iget v5, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->index:I

    add-int/lit8 v6, v5, 0x1

    iput v6, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->index:I
...
.method public reset()V
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->workingKey:[B
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->workingKey:[B
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/engines/Grain128Engine;->workingIV:[B
    ...
    invoke-virtual {p0, v2, v3}, Lorg/bouncycastle/crypto/engines/Grain128Engine;->shift([II)[I
...
.method public final shift([II)[I
    .locals 3
