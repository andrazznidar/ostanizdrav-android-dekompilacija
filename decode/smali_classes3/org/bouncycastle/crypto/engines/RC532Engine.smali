...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iget v0, p2, Lorg/bouncycastle/crypto/params/RC5Parameters;->rounds:I

    iput v0, p0, Lorg/bouncycastle/crypto/engines/RC532Engine;->_noRounds:I

    iget-object p2, p2, Lorg/bouncycastle/crypto/params/RC5Parameters;->key:[B

    invoke-virtual {p0, p2}, Lorg/bouncycastle/crypto/engines/RC532Engine;->setKey([B)V
...
.method public processBlock([BI[BI)I
    ...
    invoke-virtual {p0, p1, p2}, Lorg/bouncycastle/crypto/engines/RC532Engine;->bytesToWord([BI)I
    ...
    :goto_0
    iget v1, p0, Lorg/bouncycastle/crypto/engines/RC532Engine;->_noRounds:I

    if-gt p2, v1, :cond_0

    xor-int/2addr v0, p1

    invoke-virtual {p0, v0, p1}, Lorg/bouncycastle/crypto/engines/RC532Engine;->rotateLeft(II)I
    ...
    invoke-virtual {p0, p1, v0}, Lorg/bouncycastle/crypto/engines/RC532Engine;->rotateLeft(II)I
    ...
    :cond_0
    invoke-virtual {p0, v0, p3, p4}, Lorg/bouncycastle/crypto/engines/RC532Engine;->wordToBytes(I[BI)V

    add-int/lit8 p4, p4, 0x4

    invoke-virtual {p0, p1, p3, p4}, Lorg/bouncycastle/crypto/engines/RC532Engine;->wordToBytes(I[BI)V
...
.method public final setKey([B)V
    ...
    invoke-virtual {p0, v10, v1}, Lorg/bouncycastle/crypto/engines/RC532Engine;->rotateLeft(II)I
    ...
    invoke-virtual {p0, v9, v7}, Lorg/bouncycastle/crypto/engines/RC532Engine;->rotateLeft(II)I
