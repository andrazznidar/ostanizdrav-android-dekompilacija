.class public Lcom/networknt/schema/ExclusiveMinimumValidator;
.super Lcom/networknt/schema/BaseJsonValidator;
.source "ExclusiveMinimumValidator.java"
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/networknt/schema/ExclusiveMinimumValidator;->logger:Lorg/slf4j/Logger;
...
.method public constructor <init>(Ljava/lang/String;Lcom/fasterxml/jackson/databind/JsonNode;Lcom/networknt/schema/JsonSchema;Lcom/networknt/schema/ValidationContext;)V
    ...
    sget-object v4, Lcom/networknt/schema/ValidatorTypeCode;->EXCLUSIVE_MINIMUM:Lcom/networknt/schema/ValidatorTypeCode;
    ...
    new-instance p4, Lcom/networknt/schema/ExclusiveMinimumValidator$1;

    invoke-direct {p4, p0, p1, p2, p3}, Lcom/networknt/schema/ExclusiveMinimumValidator$1;-><init>(Lcom/networknt/schema/ExclusiveMinimumValidator;Ljava/lang/String;J)V

    iput-object p4, p0, Lcom/networknt/schema/ExclusiveMinimumValidator;->typedMinimum:Lcom/networknt/schema/ThresholdMixin;

    goto :goto_0

    :cond_1
    new-instance p3, Lcom/networknt/schema/ExclusiveMinimumValidator$2;

    invoke-direct {p3, p0, p2, p1}, Lcom/networknt/schema/ExclusiveMinimumValidator$2;-><init>(Lcom/networknt/schema/ExclusiveMinimumValidator;Lcom/fasterxml/jackson/databind/JsonNode;Ljava/lang/String;)V

    iput-object p3, p0, Lcom/networknt/schema/ExclusiveMinimumValidator;->typedMinimum:Lcom/networknt/schema/ThresholdMixin;
    ...
    const-string p2, "exclusiveMinimum value is not a number"
...
.method public validate(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/fasterxml/jackson/databind/JsonNode;Ljava/lang/String;)Ljava/util/Set;
    ...
    sget-object v0, Lcom/networknt/schema/ExclusiveMinimumValidator;->logger:Lorg/slf4j/Logger;
    ...
    :cond_0
    iget-object p2, p0, Lcom/networknt/schema/ExclusiveMinimumValidator;->typedMinimum:Lcom/networknt/schema/ThresholdMixin;
    ...
    iget-object v0, p0, Lcom/networknt/schema/ExclusiveMinimumValidator;->typedMinimum:Lcom/networknt/schema/ThresholdMixin;
