.class public Lcom/networknt/schema/MaximumValidator;
.super Lcom/networknt/schema/BaseJsonValidator;
.source "MaximumValidator.java"


# static fields
.field private static final PROPERTY_EXCLUSIVE_MAXIMUM:Ljava/lang/String; = "exclusiveMaximum"
...
.method public static constructor <clinit>()V
    ...
    const-class v0, Lcom/networknt/schema/MaximumValidator;

    invoke-static {v0}, Lorg/slf4j/LoggerFactory;->getLogger(Ljava/lang/Class;)Lorg/slf4j/Logger;

    move-result-object v0

    sput-object v0, Lcom/networknt/schema/MaximumValidator;->logger:Lorg/slf4j/Logger;
...
.method public constructor <init>(Ljava/lang/String;Lcom/fasterxml/jackson/databind/JsonNode;Lcom/networknt/schema/JsonSchema;Lcom/networknt/schema/ValidationContext;)V
    ...
    sget-object v4, Lcom/networknt/schema/ValidatorTypeCode;->MAXIMUM:Lcom/networknt/schema/ValidatorTypeCode;
    ...
    iput-boolean p1, p0, Lcom/networknt/schema/MaximumValidator;->excludeEqual:Z
    ...
    const-string p3, "exclusiveMaximum"
    ...
    new-instance p1, Lcom/networknt/schema/MaximumValidator$1;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/networknt/schema/MaximumValidator$1;-><init>(Lcom/networknt/schema/MaximumValidator;Lcom/fasterxml/jackson/databind/JsonNode;Ljava/lang/String;J)V

    iput-object p1, p0, Lcom/networknt/schema/MaximumValidator;->typedMaximum:Lcom/networknt/schema/ThresholdMixin;

    goto :goto_0

    :cond_2
    new-instance p1, Lcom/networknt/schema/MaximumValidator$2;

    invoke-direct {p1, p0, p2, v3}, Lcom/networknt/schema/MaximumValidator$2;-><init>(Lcom/networknt/schema/MaximumValidator;Lcom/fasterxml/jackson/databind/JsonNode;Ljava/lang/String;)V
    ...
    const-string p2, "maximum value is not a number"
...
.method public static synthetic access$000(Lcom/networknt/schema/MaximumValidator;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/networknt/schema/MaximumValidator;->excludeEqual:Z
...
.method public validate(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/fasterxml/jackson/databind/JsonNode;Ljava/lang/String;)Ljava/util/Set;
    ...
    sget-object v0, Lcom/networknt/schema/MaximumValidator;->logger:Lorg/slf4j/Logger;
    ...
    :cond_0
    iget-object p2, p0, Lcom/networknt/schema/MaximumValidator;->typedMaximum:Lcom/networknt/schema/ThresholdMixin;
    ...
    iget-object v0, p0, Lcom/networknt/schema/MaximumValidator;->typedMaximum:Lcom/networknt/schema/ThresholdMixin;
