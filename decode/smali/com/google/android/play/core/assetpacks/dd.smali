...
.method public constructor <init>()V
    ...
    invoke-virtual {p0}, Lcom/google/android/play/core/assetpacks/dd;->d()V
...
.method public final a([BII)I
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, Lcom/google/android/play/core/assetpacks/dd;->e(I[BII)I
    ...
    invoke-virtual {p0, v3, p1, p2, p3}, Lcom/google/android/play/core/assetpacks/dd;->e(I[BII)I
...
.method public final b()Lcom/google/android/play/core/assetpacks/dy;
    .locals 19

    move-object/from16 v0, p0

    iget v1, v0, Lcom/google/android/play/core/assetpacks/dd;->b:I

    iget v2, v0, Lcom/google/android/play/core/assetpacks/dd;->f:I

    if-ge v1, v2, :cond_0

    iget-object v4, v0, Lcom/google/android/play/core/assetpacks/dd;->i:Ljava/lang/String;

    iget-wide v5, v0, Lcom/google/android/play/core/assetpacks/dd;->d:J

    iget v7, v0, Lcom/google/android/play/core/assetpacks/dd;->g:I

    const/4 v8, 0x1

    iget-object v2, v0, Lcom/google/android/play/core/assetpacks/dd;->a:[B

    invoke-static {v2, v1}, Ljava/util/Arrays;->copyOf([BI)[B

    move-result-object v10

    iget-boolean v9, v0, Lcom/google/android/play/core/assetpacks/dd;->h:Z

    new-instance v1, Lcom/google/android/play/core/assetpacks/dy;

    move-object v3, v1

    invoke-direct/range {v3 .. v10}, Lcom/google/android/play/core/assetpacks/dy;-><init>(Ljava/lang/String;JIZZ[B)V

    return-object v1

    :cond_0
    iget-object v12, v0, Lcom/google/android/play/core/assetpacks/dd;->i:Ljava/lang/String;

    iget-wide v13, v0, Lcom/google/android/play/core/assetpacks/dd;->d:J

    iget v15, v0, Lcom/google/android/play/core/assetpacks/dd;->g:I

    iget-object v1, v0, Lcom/google/android/play/core/assetpacks/dd;->a:[B

    invoke-static {v1, v2}, Ljava/util/Arrays;->copyOf([BI)[B

    move-result-object v18

    iget-boolean v1, v0, Lcom/google/android/play/core/assetpacks/dd;->h:Z
    ...
    invoke-direct/range {v11 .. v18}, Lcom/google/android/play/core/assetpacks/dy;-><init>(Ljava/lang/String;JIZZ[B)V

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/play/core/assetpacks/dd;->d()V
