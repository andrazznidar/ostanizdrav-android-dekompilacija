...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v5, p0, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel$createPDF$1;->$view:Landroid/view/View;
    ...
    const-string v6, "cwa-qr-code.pdf"
    ...
    invoke-direct {v1, v6, v7, v4}, Landroid/graphics/pdf/PdfDocument$PageInfo$Builder;-><init>(III)V
    ...
    new-instance v6, Landroid/graphics/pdf/PdfDocument;

    invoke-direct {v6}, Landroid/graphics/pdf/PdfDocument;-><init>()V

    invoke-virtual {v6, v1}, Landroid/graphics/pdf/PdfDocument;->startPage(Landroid/graphics/pdf/PdfDocument$PageInfo;)Landroid/graphics/pdf/PdfDocument$Page;
    ...
    invoke-virtual {v9, v7, v8}, Landroid/graphics/Canvas;->scale(FF)V
    ...
    invoke-virtual {v6, v1}, Landroid/graphics/pdf/PdfDocument;->finishPage(Landroid/graphics/pdf/PdfDocument$Page;)V
    ...
    :try_start_2
    invoke-virtual {v6, p1}, Landroid/graphics/pdf/PdfDocument;->writeTo(Ljava/io/OutputStream;)V
    ...
    iget-object v6, p1, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel;->fileSharing:Lde/rki/coronawarnapp/util/files/FileSharing;
    ...
    iput-object v6, p0, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel$createPDF$1;->L$1:Ljava/lang/Object;

    iput-object v5, p0, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel$createPDF$1;->L$2:Ljava/lang/Object;

    iput v4, p0, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel$createPDF$1;->label:I

    iget-object v4, p1, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel;->traceLocationRepository:Lde/rki/coronawarnapp/presencetracing/storage/repo/TraceLocationRepository;

    iget-wide v7, p1, Lde/rki/coronawarnapp/ui/presencetracing/organizer/poster/QrCodePosterViewModel;->traceLocationId:J

    invoke-interface {v4, v7, v8, p0}, Lde/rki/coronawarnapp/presencetracing/storage/repo/TraceLocationRepository;->traceLocationForId(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
