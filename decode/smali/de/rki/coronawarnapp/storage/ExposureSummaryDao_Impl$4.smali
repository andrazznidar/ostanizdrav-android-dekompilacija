...
.method public call()Ljava/lang/Object;
    ...
    invoke-static {v0, v5}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getColumnIndexOrThrow(Landroid/database/Cursor;Ljava/lang/String;)I

    move-result v5

    const-string v6, "summationRiskScore"

    invoke-static {v0, v6}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getColumnIndexOrThrow(Landroid/database/Cursor;Ljava/lang/String;)I

    move-result v6

    const-string v7, "attenuationDurationsInMinutes"

    invoke-static {v0, v7}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getColumnIndexOrThrow(Landroid/database/Cursor;Ljava/lang/String;)I
    ...
    new-instance v3, Lde/rki/coronawarnapp/storage/ExposureSummaryEntity;

    invoke-direct {v3}, Lde/rki/coronawarnapp/storage/ExposureSummaryEntity;-><init>()V

    invoke-interface {v0, v1}, Landroid/database/Cursor;->getLong(I)J

    move-result-wide v8

    iput-wide v8, v3, Lde/rki/coronawarnapp/storage/ExposureSummaryEntity;->id:J

    invoke-interface {v0, v2}, Landroid/database/Cursor;->getInt(I)I

    move-result v1

    iput v1, v3, Lde/rki/coronawarnapp/storage/ExposureSummaryEntity;->daysSinceLastExposure:I

    invoke-interface {v0, v4}, Landroid/database/Cursor;->getInt(I)I

    move-result v1

    iput v1, v3, Lde/rki/coronawarnapp/storage/ExposureSummaryEntity;->matchedKeyCount:I

    invoke-interface {v0, v5}, Landroid/database/Cursor;->getInt(I)I

    move-result v1

    iput v1, v3, Lde/rki/coronawarnapp/storage/ExposureSummaryEntity;->maximumRiskScore:I

    invoke-interface {v0, v6}, Landroid/database/Cursor;->getInt(I)I

    move-result v1

    iput v1, v3, Lde/rki/coronawarnapp/storage/ExposureSummaryEntity;->summationRiskScore:I
    ...
    iget-object v2, v2, Lde/rki/coronawarnapp/storage/ExposureSummaryDao_Impl;->__converters:Lde/rki/coronawarnapp/util/Converters;

    invoke-virtual {v2, v1}, Lde/rki/coronawarnapp/util/Converters;->fromString(Ljava/lang/String;)Ljava/util/List;

    move-result-object v1

    iput-object v1, v3, Lde/rki/coronawarnapp/storage/ExposureSummaryEntity;->attenuationDurationsInMinutes:Ljava/util/List;
    :try_end_0
