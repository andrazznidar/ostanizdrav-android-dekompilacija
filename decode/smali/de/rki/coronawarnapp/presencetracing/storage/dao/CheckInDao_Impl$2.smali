.class public Lde/rki/coronawarnapp/presencetracing/storage/dao/CheckInDao_Impl$2;
...
.method public constructor <init>(Lde/rki/coronawarnapp/presencetracing/storage/dao/CheckInDao_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lde/rki/coronawarnapp/presencetracing/storage/dao/CheckInDao_Impl$2;->this$0:Lde/rki/coronawarnapp/presencetracing/storage/dao/CheckInDao_Impl;
...
.method public bind(Landroidx/sqlite/db/framework/FrameworkSQLiteStatement;Ljava/lang/Object;)V
    ...
    :goto_2
    iget-object v0, p0, Lde/rki/coronawarnapp/presencetracing/storage/dao/CheckInDao_Impl$2;->this$0:Lde/rki/coronawarnapp/presencetracing/storage/dao/CheckInDao_Impl;
    ...
    iget-boolean v0, p2, Lde/rki/coronawarnapp/presencetracing/storage/entity/TraceLocationCheckInEntity;->hasSubmissionConsent:Z
    ...
    iget-wide v1, p2, Lde/rki/coronawarnapp/presencetracing/storage/entity/TraceLocationCheckInEntity;->id:J
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `checkin` SET `id` = ?,`traceLocationIdBase64` = ?,`version` = ?,`type` = ?,`description` = ?,`address` = ?,`traceLocationStart` = ?,`traceLocationEnd` = ?,`defaultCheckInLengthInMinutes` = ?,`cryptographicSeedBase64` = ?,`cnPublicKey` = ?,`checkInStart` = ?,`checkInEnd` = ?,`completed` = ?,`createJournalEntry` = ?,`submitted` = ?,`submissionConsent` = ? WHERE `id` = ?"
