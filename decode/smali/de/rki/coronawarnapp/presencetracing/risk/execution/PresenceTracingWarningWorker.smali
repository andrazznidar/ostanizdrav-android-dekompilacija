.class public final Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker;
.super Landroidx/work/CoroutineWorker;
.source "PresenceTracingWarningWorker.kt"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker;",
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/WorkerParameters;Lde/rki/coronawarnapp/task/TaskController;)V
    ...
    iput-object p3, p0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker;->taskController:Lde/rki/coronawarnapp/task/TaskController;
...
.method public doWork(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v0, p1, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;

    if-eqz v0, :cond_0

    move-object v0, p1

    check-cast v0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;

    iget v1, v0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;->label:I
    ...
    iput v1, v0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;->label:I

    goto :goto_0

    :cond_0
    new-instance v0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;

    invoke-direct {v0, p0, p1}, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;-><init>(Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p1, v0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;->result:Ljava/lang/Object;

    sget-object v1, Lkotlin/coroutines/intrinsics/CoroutineSingletons;->COROUTINE_SUSPENDED:Lkotlin/coroutines/intrinsics/CoroutineSingletons;

    iget v2, v0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;->label:I

    const/4 v3, 0x1

    const/4 v4, 0x0

    const-string v5, "PresenceTracingWarningWorker"

    if-eqz v2, :cond_2

    if-ne v2, v3, :cond_1

    iget-object v0, v0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;->L$0:Ljava/lang/Object;

    check-cast v0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker;
    ...
    const-class v6, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningTask;
    ...
    iput v3, v0, Lde/rki/coronawarnapp/presencetracing/risk/execution/PresenceTracingWarningWorker$doWork$1;->label:I
    ...
    const-string v0, ": PresenceTracingWarningTask finished successfully."
    ...
    const-string v0, ": Error during PresenceTracingWarningTask."
