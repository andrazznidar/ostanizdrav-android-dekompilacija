...
.method public static synthetic access$000(Lde/rki/coronawarnapp/contactdiary/storage/ContactDiaryDatabase_Impl;)Ljava/util/List;
    .locals 0
...
.method public static synthetic access$300(Lde/rki/coronawarnapp/contactdiary/storage/ContactDiaryDatabase_Impl;)Ljava/util/List;
    .locals 0
...
.method public clearAllTables()V
    ...
    :cond_1
    const-string v5, "DELETE FROM `locations`"

    invoke-interface {v0, v5}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v5, "DELETE FROM `locationvisits`"

    invoke-interface {v0, v5}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v5, "DELETE FROM `persons`"

    invoke-interface {v0, v5}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v5, "DELETE FROM `personencounters`"
