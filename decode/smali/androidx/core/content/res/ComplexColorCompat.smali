...
.method public static createFromXml(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroidx/core/content/res/ComplexColorCompat;
    ...
    invoke-static {v0, v1, v3, v4}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->obtainAttributes1(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v4, v2, v9, v7, v10}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {v4, v2, v12, v9, v10}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {v4, v2, v8, v12, v11}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getNamedInt(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-static {v4, v2, v5, v12, v11}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getNamedColor(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I

    move-result v5

    const-string v12, "centerColor"

    invoke-static {v2, v12}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->hasAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z

    move-result v18

    sget v6, Landroidx/core/R$styleable;->GradientColor_android_centerColor:I

    invoke-static {v4, v2, v12, v6, v11}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getNamedColor(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-static {v4, v2, v10, v12, v11}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getNamedColor(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-static {v4, v2, v0, v12, v11}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getNamedInt(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-static {v4, v2, v11, v12, v7}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {v7, v1, v3, v9}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->obtainAttributes1(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    :cond_17
    invoke-static {v0, v2, v3, v1}, Landroid/support/v4/media/MediaDescriptionCompatApi21$Builder;->createFromXmlInner(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
