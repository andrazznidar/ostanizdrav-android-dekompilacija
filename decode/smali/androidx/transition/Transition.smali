...
.field public mEndValues:Landroidx/constraintlayout/core/Cache;
...
.field public mStartValues:Landroidx/constraintlayout/core/Cache;
...
.method public constructor <init>()V
    ...
    invoke-direct {v1, v2}, Landroidx/constraintlayout/core/Cache;-><init>(I)V

    iput-object v1, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/constraintlayout/core/Cache;

    new-instance v1, Landroidx/constraintlayout/core/Cache;

    invoke-direct {v1, v2}, Landroidx/constraintlayout/core/Cache;-><init>(I)V

    iput-object v1, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/constraintlayout/core/Cache;
...
.method public static addViewValues(Landroidx/constraintlayout/core/Cache;Landroid/view/View;Landroidx/transition/TransitionValues;)V
    .locals 6
    ...
    iget-object p2, p0, Landroidx/constraintlayout/core/Cache;->solverVariablePool:Ljava/lang/Object;
    ...
    iget-object p1, p0, Landroidx/constraintlayout/core/Cache;->solverVariablePool:Ljava/lang/Object;
    ...
    iget-object p0, p0, Landroidx/constraintlayout/core/Cache;->solverVariablePool:Ljava/lang/Object;
...
.method public final captureHierarchy(Landroid/view/View;Z)V
    ...
    iget-object v1, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/constraintlayout/core/Cache;

    invoke-static {v1, p1, v0}, Landroidx/transition/Transition;->addViewValues(Landroidx/constraintlayout/core/Cache;Landroid/view/View;Landroidx/transition/TransitionValues;)V

    goto :goto_1

    :cond_2
    iget-object v1, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/constraintlayout/core/Cache;
...
.method public capturePropagationValues(Landroidx/transition/TransitionValues;)V
    ...
    check-cast v0, Landroidx/transition/SidePropagation;
...
.method public captureValues(Landroid/view/ViewGroup;Z)V
    ...
    iget-object v4, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/constraintlayout/core/Cache;

    invoke-static {v4, v2, v3}, Landroidx/transition/Transition;->addViewValues(Landroidx/constraintlayout/core/Cache;Landroid/view/View;Landroidx/transition/TransitionValues;)V

    goto :goto_3

    :cond_3
    iget-object v4, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/constraintlayout/core/Cache;
    ...
    iget-object v2, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/constraintlayout/core/Cache;

    invoke-static {v2, p1, v1}, Landroidx/transition/Transition;->addViewValues(Landroidx/constraintlayout/core/Cache;Landroid/view/View;Landroidx/transition/TransitionValues;)V

    goto :goto_6

    :cond_7
    iget-object v2, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/constraintlayout/core/Cache;
...
.method public clearValues(Z)V
    ...
    iget-object p1, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/constraintlayout/core/Cache;

    iget-object p1, p1, Landroidx/constraintlayout/core/Cache;->optimizedArrayRowPool:Ljava/lang/Object;
    ...
    iget-object p1, p1, Landroidx/constraintlayout/core/Cache;->arrayRowPool:Ljava/lang/Object;
    ...
    iget-object p1, p1, Landroidx/constraintlayout/core/Cache;->solverVariablePool:Ljava/lang/Object;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/constraintlayout/core/Cache;
...
.method public clone()Landroidx/transition/Transition;
    ...
    invoke-direct {v2, v3}, Landroidx/constraintlayout/core/Cache;-><init>(I)V

    iput-object v2, v1, Landroidx/transition/Transition;->mStartValues:Landroidx/constraintlayout/core/Cache;

    new-instance v2, Landroidx/constraintlayout/core/Cache;

    invoke-direct {v2, v3}, Landroidx/constraintlayout/core/Cache;-><init>(I)V

    iput-object v2, v1, Landroidx/transition/Transition;->mEndValues:Landroidx/constraintlayout/core/Cache;
...
.method public createAnimators(Landroid/view/ViewGroup;Landroidx/constraintlayout/core/Cache;Landroidx/constraintlayout/core/Cache;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget-object v13, v10, Landroidx/constraintlayout/core/Cache;->optimizedArrayRowPool:Ljava/lang/Object;

    check-cast v13, Landroidx/collection/ArrayMap;

    invoke-virtual {v13, v4}, Landroidx/collection/SimpleArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v14, v11, Landroidx/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    iget-object v12, v13, Landroidx/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    iget v5, v8, Landroidx/collection/SimpleArrayMap;->mSize:I
    ...
    invoke-virtual {v12, v11}, Landroidx/transition/TransitionValues;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v10, v6, Landroidx/transition/Transition;->mPropagation:Landroidx/transition/TransitionPropagation;

    if-eqz v10, :cond_1e

    check-cast v10, Landroidx/transition/SidePropagation;
    ...
    :cond_b
    iget-object v13, v6, Landroidx/transition/Transition;->mEpicenterCallback:Landroidx/transition/Transition$EpicenterCallback;
    ...
    :cond_c
    invoke-virtual {v13, v6}, Landroidx/transition/Transition$EpicenterCallback;->onGetEpicenter(Landroidx/transition/Transition;)Landroid/graphics/Rect;
    ...
    :cond_d
    iget-object v14, v2, Landroidx/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    invoke-static {v2, v11}, Landroidx/transition/SidePropagation;->getViewCoordinate(Landroidx/transition/TransitionValues;I)I

    move-result v12

    const/4 v14, 0x1

    invoke-static {v2, v14}, Landroidx/transition/SidePropagation;->getViewCoordinate(Landroidx/transition/TransitionValues;I)I
    ...
    :goto_c
    iget v11, v10, Landroidx/transition/SidePropagation;->mSide:I
    ...
    iget v5, v10, Landroidx/transition/SidePropagation;->mSide:I
    ...
    iget-wide v10, v6, Landroidx/transition/Transition;->mDuration:J
    ...
    new-instance v8, Landroidx/transition/Transition$AnimationInfo;
    ...
    invoke-direct {v5, v7}, Landroidx/transition/WindowIdApi18;-><init>(Landroid/view/View;)V
    ...
    invoke-virtual {v2, v15, v8}, Landroidx/collection/SimpleArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public end()V
    ...
    :goto_1
    iget-object v3, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/constraintlayout/core/Cache;

    iget-object v3, v3, Landroidx/constraintlayout/core/Cache;->solverVariablePool:Ljava/lang/Object;
    ...
    :goto_2
    iget-object v3, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/constraintlayout/core/Cache;
...
.method public getTransitionValues(Landroid/view/View;Z)Landroidx/transition/TransitionValues;
    ...
    iget-object p2, p0, Landroidx/transition/Transition;->mStartValues:Landroidx/constraintlayout/core/Cache;

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroidx/transition/Transition;->mEndValues:Landroidx/constraintlayout/core/Cache;

    :goto_0
    iget-object p2, p2, Landroidx/constraintlayout/core/Cache;->optimizedArrayRowPool:Ljava/lang/Object;
...
.method public pause(Landroid/view/View;)V
    ...
    iget-object v4, v4, Landroidx/transition/Transition$AnimationInfo;->mWindowId:Landroidx/transition/WindowIdImpl;

    instance-of v5, v4, Landroidx/transition/WindowIdApi18;

    if-eqz v5, :cond_0

    check-cast v4, Landroidx/transition/WindowIdApi18;

    iget-object v4, v4, Landroidx/transition/WindowIdApi18;->mWindowId:Landroid/view/WindowId;
