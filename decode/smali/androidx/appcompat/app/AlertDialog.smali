...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget v13, v1, Landroidx/appcompat/app/AlertController;->mViewLayoutResId:I
    ...
    iget-boolean v10, v1, Landroidx/appcompat/app/AlertController;->mViewSpacingSpecified:Z

    if-eqz v10, :cond_7

    iget v10, v1, Landroidx/appcompat/app/AlertController;->mViewSpacingLeft:I

    iget v13, v1, Landroidx/appcompat/app/AlertController;->mViewSpacingTop:I

    iget v12, v1, Landroidx/appcompat/app/AlertController;->mViewSpacingRight:I

    iget v14, v1, Landroidx/appcompat/app/AlertController;->mViewSpacingBottom:I

    invoke-virtual {v3, v10, v13, v12, v14}, Landroid/widget/FrameLayout;->setPadding(IIII)V
    ...
    iput v10, v3, Landroidx/appcompat/widget/LinearLayoutCompat$LayoutParams;->weight:F
    ...
    invoke-virtual {v1, v3, v5}, Landroidx/appcompat/app/AlertController;->resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v3

    invoke-virtual {v1, v4, v7}, Landroidx/appcompat/app/AlertController;->resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v4

    invoke-virtual {v1, v6, v9}, Landroidx/appcompat/app/AlertController;->resolvePanel(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    :cond_28
    iget v12, v3, Landroidx/appcompat/app/AlertController$RecycleListView;->mPaddingBottomNoButtons:I

    :goto_13
    invoke-virtual {v3, v6, v7, v9, v12}, Landroid/widget/ListView;->setPadding(IIII)V
    ...
    invoke-static {v3, v2, v5}, Landroidx/core/view/ViewCompat;->setScrollIndicators(Landroid/view/View;II)V
