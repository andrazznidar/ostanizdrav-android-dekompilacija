...
.method public run()V
    ...
    iget-object v0, v1, Landroidx/work/impl/WorkerWrapper;->mWorkTagDao:Landroidx/work/impl/model/WorkTagDao;
    ...
    :goto_0
    iget-object v2, v0, Landroidx/work/impl/model/WorkTagDao_Impl;->__db:Landroidx/room/RoomDatabase;
    ...
    iput-object v0, v1, Landroidx/work/impl/WorkerWrapper;->mTags:Ljava/util/List;
    ...
    :try_start_1
    iget-object v4, v1, Landroidx/work/impl/WorkerWrapper;->mWorkSpecDao:Landroidx/work/impl/model/WorkSpecDao;
    ...
    iput-object v4, v1, Landroidx/work/impl/WorkerWrapper;->mWorkSpec:Landroidx/work/impl/model/WorkSpec;
    ...
    invoke-virtual {v0, v3, v4, v5}, Landroidx/work/Logger;->error(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-virtual {v1, v2}, Landroidx/work/impl/WorkerWrapper;->resolve(Z)V
    :try_end_2
    ...
    invoke-virtual {v4}, Landroidx/work/impl/model/WorkSpec;->isBackedOff()Z
    ...
    iget-wide v8, v4, Landroidx/work/impl/model/WorkSpec;->periodStartTime:J
    ...
    iget-object v4, v4, Landroidx/work/Configuration;->mInputMergerFactory:Landroidx/work/InputMergerFactory;
    ...
    invoke-static {v6}, Landroidx/work/InputMerger;->fromClassName(Ljava/lang/String;)Landroidx/work/InputMerger;
    ...
    invoke-virtual {v0, v3, v4, v2}, Landroidx/work/Logger;->error(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-static {v9, v5}, Landroidx/room/RoomSQLiteQuery;->acquire(Ljava/lang/String;I)Landroidx/room/RoomSQLiteQuery;

    move-result-object v9

    if-nez v8, :cond_c

    invoke-virtual {v9, v5}, Landroidx/room/RoomSQLiteQuery;->bindNull(I)V

    goto :goto_7

    :cond_c
    invoke-virtual {v9, v5, v8}, Landroidx/room/RoomSQLiteQuery;->bindString(ILjava/lang/String;)V

    :goto_7
    iget-object v8, v7, Landroidx/work/impl/model/WorkSpecDao_Impl;->__db:Landroidx/room/RoomDatabase;

    invoke-virtual {v8}, Landroidx/room/RoomDatabase;->assertNotSuspendingTransaction()V

    iget-object v7, v7, Landroidx/work/impl/model/WorkSpecDao_Impl;->__db:Landroidx/room/RoomDatabase;

    invoke-static {v7, v9, v2, v3}, Landroidx/room/util/DBUtil;->query(Landroidx/room/RoomDatabase;Landroidx/sqlite/db/SupportSQLiteQuery;ZLandroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-virtual {v4, v6}, Landroidx/work/InputMerger;->merge(Ljava/util/List;)Landroidx/work/Data;
    ...
    iget v11, v4, Landroidx/work/impl/model/WorkSpec;->runAttemptCount:I

    iget-object v4, v1, Landroidx/work/impl/WorkerWrapper;->mConfiguration:Landroidx/work/Configuration;

    iget-object v12, v4, Landroidx/work/Configuration;->mExecutor:Ljava/util/concurrent/Executor;

    iget-object v13, v1, Landroidx/work/impl/WorkerWrapper;->mWorkTaskExecutor:Landroidx/work/impl/utils/taskexecutor/TaskExecutor;

    iget-object v14, v4, Landroidx/work/Configuration;->mWorkerFactory:Landroidx/work/WorkerFactory;
    ...
    invoke-direct {v15, v4, v6}, Landroidx/work/impl/utils/WorkProgressUpdater;-><init>(Landroidx/work/impl/WorkDatabase;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;)V
    ...
    invoke-direct {v4, v6, v2}, Landroidx/work/impl/utils/WorkForegroundUpdater;-><init>(Landroidx/work/impl/foreground/ForegroundProcessor;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;)V

    move-object v6, v3

    move-object/from16 v16, v4

    invoke-direct/range {v6 .. v16}, Landroidx/work/WorkerParameters;-><init>(Ljava/util/UUID;Landroidx/work/Data;Ljava/util/Collection;Landroidx/work/WorkerParameters$RuntimeExtras;ILjava/util/concurrent/Executor;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/WorkerFactory;Landroidx/work/ProgressUpdater;Landroidx/work/impl/utils/WorkForegroundUpdater;)V
    ...
    invoke-virtual {v2, v4, v6, v3}, Landroidx/work/WorkerFactory;->createWorkerWithDefaultFallback(Landroid/content/Context;Ljava/lang/String;Landroidx/work/WorkerParameters;)Landroidx/work/ListenableWorker;
    ...
    :cond_10
    iput-boolean v5, v2, Landroidx/work/ListenableWorker;->mUsed:Z
    ...
    :try_start_5
    iget-object v2, v1, Landroidx/work/impl/WorkerWrapper;->mWorkSpecDao:Landroidx/work/impl/model/WorkSpecDao;
    ...
    :try_start_7
    invoke-virtual {v0, v2, v3}, Landroidx/work/impl/model/WorkSpecDao_Impl;->setState(Landroidx/work/WorkInfo$State;[Ljava/lang/String;)I
    ...
    iget-object v2, v2, Landroidx/work/impl/utils/taskexecutor/WorkManagerTaskExecutor;->mMainThreadExecutor:Ljava/util/concurrent/Executor;
