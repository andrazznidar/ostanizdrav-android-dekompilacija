...
.field public static volatile defaultParameters:Lorg/conscrypt/SSLParametersImpl;

.field public static volatile defaultX509KeyManager:Ljavax/net/ssl/X509KeyManager;

.field public static volatile defaultX509TrustManager:Ljavax/net/ssl/X509TrustManager;


# instance fields
.field public algorithmConstraints:Ljava/security/AlgorithmConstraints;
...
.field public final clientSessionContext:Lorg/conscrypt/ClientSessionContext;

.field public client_mode:Z

.field public ctVerificationEnabled:Z

.field public enable_session_creation:Z

.field public enabledCipherSuites:[Ljava/lang/String;

.field public enabledProtocols:[Ljava/lang/String;

.field public endpointIdentificationAlgorithm:Ljava/lang/String;

.field public isEnabledProtocolsFiltered:Z

.field public need_client_auth:Z

.field public ocspResponse:[B

.field public final pskKeyManager:Lorg/conscrypt/PSKKeyManager;

.field public sctExtension:[B

.field public final serverSessionContext:Lorg/conscrypt/ServerSessionContext;

.field public sniMatchers:Ljava/util/Collection;
...
.field public useCipherSuitesOrder:Z

.field public useSessionTickets:Z

.field public useSni:Ljava/lang/Boolean;

.field public want_client_auth:Z

.field public final x509KeyManager:Ljavax/net/ssl/X509KeyManager;
...
.method public static createDefaultX509KeyManager()Ljavax/net/ssl/X509KeyManager;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/KeyManagementException;
...
.method public static createDefaultX509TrustManager()Ljavax/net/ssl/X509TrustManager;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/KeyManagementException;
...
.method public static filterFromCipherSuites([Ljava/lang/String;Ljava/util/Set;)[Ljava/lang/String;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
...
.method public static filterFromProtocols([Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
    .locals 5
...
.method public static findFirstPSKKeyManager([Ljavax/net/ssl/KeyManager;)Lorg/conscrypt/PSKKeyManager;
    .locals 4
...
.method public static findFirstX509KeyManager([Ljavax/net/ssl/KeyManager;)Ljavax/net/ssl/X509KeyManager;
    .locals 4
...
.method public static findFirstX509TrustManager([Ljavax/net/ssl/TrustManager;)Ljavax/net/ssl/X509TrustManager;
    .locals 4
...
.method public static getDefaultCipherSuites(ZZ)[Ljava/lang/String;
    .locals 4
...
.method public static getDefaultX509KeyManager()Ljavax/net/ssl/X509KeyManager;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/KeyManagementException;
