...
# static fields
.field public static final TRUST_ANCHOR_COMPARATOR:Lorg/conscrypt/TrustManagerImpl$TrustAnchorComparator;

.field public static defaultHostnameVerifier:Lorg/conscrypt/ConscryptHostnameVerifier;
...
.field public ctPolicy:Lorg/conscrypt/ct/CTPolicy;

.field public ctVerifier:Lorg/conscrypt/ct/CTVerifier;

.field public final err:Ljava/lang/Exception;

.field public final factory:Ljava/security/cert/CertificateFactory;

.field public hostnameVerifier:Lorg/conscrypt/ConscryptHostnameVerifier;

.field public final intermediateIndex:Lorg/conscrypt/TrustedCertificateIndex;

.field public pinManager:Lorg/conscrypt/CertPinManager;

.field public final rootKeyStore:Ljava/security/KeyStore;

.field public final trustedCertificateIndex:Lorg/conscrypt/TrustedCertificateIndex;

.field public final trustedCertificateStore:Lorg/conscrypt/ConscryptCertStore;

.field public final validator:Ljava/security/cert/CertPathValidator;
...
.method public static acceptedIssuers(Ljava/security/KeyStore;)[Ljava/security/cert/X509Certificate;
    .locals 3
...
.method private checkTrustedRecursive([Ljava/security/cert/X509Certificate;[B[BLjava/lang/String;ZLjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Set;)Ljava/util/List;
    ...
    invoke-static {v12}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline19(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static getHandshakeSessionOrThrow(Ljavax/net/ssl/SSLSocket;)Ljavax/net/ssl/SSLSession;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateException;
...
.method public static sortPotentialAnchors(Ljava/util/Set;)Ljava/util/Collection;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static trustAnchors([Ljava/security/cert/X509Certificate;)Ljava/util/Set;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
