...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/format/B;->a:Ljava/util/concurrent/ConcurrentMap;

    new-instance v0, Lj$/time/format/c;

    const/4 v1, 0x1

    invoke-direct {v0, v1}, Lj$/time/format/c;-><init>(I)V
...
.method private b(Lj$/time/temporal/o;Ljava/util/Locale;)Ljava/lang/Object;
    .locals 21
    ...
    sget-object v3, Lj$/time/format/B;->a:Ljava/util/concurrent/ConcurrentMap;
    ...
    sget-object v4, Lj$/time/temporal/a;->ERA:Lj$/time/temporal/a;
    ...
    invoke-direct {v0, v3}, Lj$/time/format/A;-><init>(Ljava/util/Map;)V
    ...
    invoke-static {v11}, Lj$/time/format/B;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v15}, Lj$/time/format/B;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4}, Lj$/time/format/B;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2, v5, v4}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v4, Lj$/time/format/G;->NARROW:Lj$/time/format/G;
    ...
    :cond_b
    sget-object v4, Lj$/time/temporal/a;->AMPM_OF_DAY:Lj$/time/temporal/a;
    ...
    :goto_4
    sget-object v2, Lj$/time/format/B;->a:Ljava/util/concurrent/ConcurrentMap;
...
.method public d(Lj$/time/temporal/o;JLj$/time/format/G;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p5}, Lj$/time/format/B;->b(Lj$/time/temporal/o;Ljava/util/Locale;)Ljava/lang/Object;
...
.method public e(Lj$/time/temporal/o;Lj$/time/format/G;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    invoke-direct {p0, p1, p3}, Lj$/time/format/B;->b(Lj$/time/temporal/o;Ljava/util/Locale;)Ljava/lang/Object;
