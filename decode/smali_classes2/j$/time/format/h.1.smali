...
.method constructor <init>(Lj$/time/temporal/o;IIZ)V
    ...
    invoke-virtual {v0}, Lj$/time/temporal/z;->f()Z
    ...
    iput-object p1, p0, Lj$/time/format/h;->a:Lj$/time/temporal/o;
...
.method public a(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    iget-object v0, p0, Lj$/time/format/h;->a:Lj$/time/temporal/o;
    ...
    invoke-interface {v0}, Lj$/time/temporal/o;->d()Lj$/time/temporal/z;

    move-result-object v0

    iget-object v4, p0, Lj$/time/format/h;->a:Lj$/time/temporal/o;

    invoke-virtual {v0, v2, v3, v4}, Lj$/time/temporal/z;->b(JLj$/time/temporal/o;)J

    invoke-virtual {v0}, Lj$/time/temporal/z;->e()J
    ...
    invoke-virtual {p1}, Lj$/time/format/C;->c()C
...
.method public b(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v5}, Lj$/time/format/C;->c()C
    ...
    invoke-virtual {v5, v2}, Lj$/time/format/C;->b(C)I
    ...
    iget-object p3, p0, Lj$/time/format/h;->a:Lj$/time/temporal/o;

    invoke-interface {p3}, Lj$/time/temporal/o;->d()Lj$/time/temporal/z;

    move-result-object p3

    invoke-virtual {p3}, Lj$/time/temporal/z;->e()J
    ...
    invoke-virtual {p3}, Lj$/time/temporal/z;->d()J
    ...
    iget-object v5, p0, Lj$/time/format/h;->a:Lj$/time/temporal/o;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lj$/time/format/h;->a:Lj$/time/temporal/o;
