...
# instance fields
.field private final a:Lj$/time/temporal/x;
...
.method constructor <init>(Lj$/time/temporal/x;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lj$/time/format/v;->a:Lj$/time/temporal/x;
...
.method private d(Lj$/time/format/x;Ljava/lang/CharSequence;IILj$/time/format/m;)I
    .locals 3
    ...
    invoke-virtual {p5, v1, p2, p4}, Lj$/time/format/m;->b(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    :cond_2
    invoke-static {v0}, Lj$/time/ZoneId;->m(Ljava/lang/String;)Lj$/time/ZoneId;
    ...
    invoke-virtual {v1, p4}, Lj$/time/format/x;->j(Lj$/time/temporal/o;)Ljava/lang/Long;
    ...
    invoke-static {p4}, Lj$/time/ZoneOffset;->s(I)Lj$/time/ZoneOffset;
...
.method public a(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    iget-object v0, p0, Lj$/time/format/v;->a:Lj$/time/temporal/x;
...
.method public b(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-direct/range {v0 .. v5}, Lj$/time/format/v;->d(Lj$/time/format/x;Ljava/lang/CharSequence;IILj$/time/format/m;)I
    ...
    :cond_4
    invoke-virtual {p0, p1}, Lj$/time/format/v;->c(Lj$/time/format/x;)Lj$/time/format/p;
...
.method protected c(Lj$/time/format/x;)Lj$/time/format/p;
    ...
    invoke-static {v0, p1}, Lj$/time/format/p;->g(Ljava/util/Set;Lj$/time/format/x;)Lj$/time/format/p;
