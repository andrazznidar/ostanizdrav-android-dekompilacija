...
.method constructor <init>(Lj$/time/format/G;Ljava/util/Set;)V
    ...
    sget p2, Lj$/time/temporal/w;->a:I
    ...
    invoke-direct {p0, p2, v0}, Lj$/time/format/v;-><init>(Lj$/time/temporal/x;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lj$/time/format/w;->e:Lj$/time/format/G;
...
.method public a(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1, v0}, Lj$/time/format/z;->f(Lj$/time/temporal/x;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->i(Lj$/time/temporal/o;)Z
    ...
    iget-object v3, p0, Lj$/time/format/w;->e:Lj$/time/format/G;
    ...
    :cond_6
    iget-object p1, p0, Lj$/time/format/w;->e:Lj$/time/format/G;
...
.method protected c(Lj$/time/format/x;)Lj$/time/format/p;
    .locals 14

    iget-object v0, p0, Lj$/time/format/w;->e:Lj$/time/format/G;

    sget-object v1, Lj$/time/format/G;->NARROW:Lj$/time/format/G;

    if-ne v0, v1, :cond_0

    invoke-super {p0, p1}, Lj$/time/format/v;->c(Lj$/time/format/x;)Lj$/time/format/p;
    ...
    iget-object v1, p0, Lj$/time/format/w;->g:Ljava/util/Map;

    goto :goto_0

    :cond_1
    iget-object v1, p0, Lj$/time/format/w;->h:Ljava/util/Map;
    ...
    check-cast v4, Lj$/time/format/p;

    if-nez v4, :cond_b

    :cond_2
    invoke-static {p1}, Lj$/time/format/p;->f(Lj$/time/format/x;)Lj$/time/format/p;
    ...
    :cond_3
    invoke-virtual {v4, v11, v11}, Lj$/time/format/p;->a(Ljava/lang/String;Ljava/lang/String;)Z

    invoke-static {v11, v0}, Lj$/time/format/H;->a(Ljava/lang/String;Ljava/util/Locale;)Ljava/lang/String;

    move-result-object v11

    iget-object v12, p0, Lj$/time/format/w;->e:Lj$/time/format/G;
    ...
    invoke-virtual {v4, v9, v11}, Lj$/time/format/p;->a(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_6
    iget-object v5, p0, Lj$/time/format/w;->f:Ljava/util/Set;
    ...
    iget-object v12, p0, Lj$/time/format/w;->f:Ljava/util/Set;
    ...
    invoke-virtual {v4, v13, v11}, Lj$/time/format/p;->a(Ljava/lang/String;Ljava/lang/String;)Z
