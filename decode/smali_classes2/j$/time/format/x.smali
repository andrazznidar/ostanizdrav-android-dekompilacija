...
.method f(Z)V
    ...
    iget-object p1, p0, Lj$/time/format/x;->d:Ljava/util/ArrayList;
...
.method h()Lj$/time/chrono/g;
    ...
    iget-object v0, v0, Lj$/time/format/D;->c:Lj$/time/chrono/g;

    if-nez v0, :cond_0

    iget-object v0, p0, Lj$/time/format/x;->a:Lj$/time/format/DateTimeFormatter;

    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->a()Lj$/time/chrono/g;
...
.method j(Lj$/time/temporal/o;)Ljava/lang/Long;
    .locals 1
...
.method o(Lj$/time/temporal/o;JII)I
    .locals 2
...
.method r()V
    ...
    iget-object v3, v1, Lj$/time/format/D;->c:Lj$/time/chrono/g;

    iput-object v3, v2, Lj$/time/format/D;->c:Lj$/time/chrono/g;
...
.method t(Lj$/time/format/E;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
    .locals 2
    ...
    invoke-virtual {p0}, Lj$/time/format/x;->h()Lj$/time/chrono/g;

    move-result-object v1

    iput-object v1, v0, Lj$/time/format/D;->c:Lj$/time/chrono/g;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/format/D;->j(Lj$/time/format/E;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
