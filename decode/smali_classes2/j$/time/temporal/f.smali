...
.method public b(Ljava/util/Map;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/E;)Lj$/time/temporal/TemporalAccessor;
    ...
    invoke-static/range {p2 .. p2}, Lj$/time/temporal/h;->j(Lj$/time/temporal/TemporalAccessor;)V

    const/4 v9, 0x1

    const/4 v10, 0x4

    invoke-static {v4, v9, v10}, Lj$/time/LocalDate;->s(III)Lj$/time/LocalDate;
    ...
    invoke-virtual {v4, v10, v11}, Lj$/time/LocalDate;->y(J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v4, v9, v10}, Lj$/time/LocalDate;->y(J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v4, v6, v7}, Lj$/time/LocalDate;->y(J)Lj$/time/LocalDate;

    move-result-object v2

    invoke-virtual {v2, v5, v12, v13}, Lj$/time/LocalDate;->C(Lj$/time/temporal/o;J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v4, v7, v8}, Lj$/time/LocalDate;->y(J)Lj$/time/LocalDate;

    move-result-object v2

    int-to-long v6, v6

    invoke-virtual {v2, v5, v6, v7}, Lj$/time/LocalDate;->C(Lj$/time/temporal/o;J)Lj$/time/LocalDate;
...
.method public c(Lj$/time/temporal/TemporalAccessor;)J
    ...
    invoke-static {p1}, Lj$/time/temporal/h;->l(Lj$/time/LocalDate;)I
