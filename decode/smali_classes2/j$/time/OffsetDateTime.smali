...
.method static constructor <clinit>()V
    ...
    invoke-direct {v2, v0, v1}, Lj$/time/OffsetDateTime;-><init>(Lj$/time/h;Lj$/time/ZoneOffset;)V
...
.method private constructor <init>(Lj$/time/h;Lj$/time/ZoneOffset;)V
    .locals 1
    ...
    iput-object p1, p0, Lj$/time/OffsetDateTime;->a:Lj$/time/h;
...
.method public static j(Lj$/time/temporal/TemporalAccessor;)Lj$/time/OffsetDateTime;
    ...
    invoke-interface {p0, v1}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/x;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v2}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/x;)Ljava/lang/Object;
    ...
    invoke-direct {v2, v1, v0}, Lj$/time/OffsetDateTime;-><init>(Lj$/time/h;Lj$/time/ZoneOffset;)V
...
.method public static k(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/OffsetDateTime;
    ...
    invoke-static {v0, v1, p0, p1}, Lj$/time/h;->u(JILj$/time/ZoneOffset;)Lj$/time/h;

    move-result-object p0

    new-instance v0, Lj$/time/OffsetDateTime;

    invoke-direct {v0, p0, p1}, Lj$/time/OffsetDateTime;-><init>(Lj$/time/h;Lj$/time/ZoneOffset;)V

    return-object v0
.end method

.method private n(Lj$/time/h;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    .locals 1

    iget-object v0, p0, Lj$/time/OffsetDateTime;->a:Lj$/time/h;
    ...
    invoke-direct {v0, p1, p2}, Lj$/time/OffsetDateTime;-><init>(Lj$/time/h;Lj$/time/ZoneOffset;)V
...
.method public a(Lj$/time/temporal/l;)Lj$/time/temporal/k;
    ...
    invoke-virtual {v0, p1}, Lj$/time/h;->I(Lj$/time/temporal/l;)Lj$/time/h;

    move-result-object p1

    iget-object v0, p0, Lj$/time/OffsetDateTime;->b:Lj$/time/ZoneOffset;

    invoke-direct {p0, p1, v0}, Lj$/time/OffsetDateTime;->n(Lj$/time/h;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
...
.method public b(Lj$/time/temporal/o;J)Lj$/time/temporal/k;
    ...
    :cond_0
    iget-object p1, p0, Lj$/time/OffsetDateTime;->a:Lj$/time/h;
    ...
    :goto_0
    invoke-direct {p0, p1, p2}, Lj$/time/OffsetDateTime;->n(Lj$/time/h;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
...
.method public compareTo(Lj$/time/OffsetDateTime;)I
    ...
    iget-object v1, p1, Lj$/time/OffsetDateTime;->a:Lj$/time/h;
    ...
    invoke-virtual {p0}, Lj$/time/OffsetDateTime;->m()Lj$/time/j;
    ...
    invoke-virtual {p1}, Lj$/time/OffsetDateTime;->m()Lj$/time/j;
    ...
    iget-object p1, p1, Lj$/time/OffsetDateTime;->a:Lj$/time/h;

    invoke-virtual {v0, p1}, Lj$/time/h;->j(Lj$/time/chrono/c;)I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Lj$/time/OffsetDateTime;->a:Lj$/time/h;

    iget-object v3, p1, Lj$/time/OffsetDateTime;->a:Lj$/time/h;
...
.method public h(Lj$/time/temporal/k;)Lj$/time/temporal/k;
    ...
    invoke-virtual {v1}, Lj$/time/h;->E()Lj$/time/LocalDate;
...
.method public plusDays(J)Lj$/time/OffsetDateTime;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/h;->w(J)Lj$/time/h;
...
.method public plusHours(J)Lj$/time/OffsetDateTime;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/h;->x(J)Lj$/time/h;
...
.method public plusMonths(J)Lj$/time/OffsetDateTime;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/h;->y(J)Lj$/time/h;
