...
# direct methods
.method private constructor <init>(Lj$/time/h;Lj$/time/ZoneOffset;Lj$/time/ZoneId;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lj$/time/ZonedDateTime;->a:Lj$/time/h;
...
.method private static h(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    .locals 3
    ...
    invoke-static {p0, p1, p2, v0}, Lj$/time/h;->u(JILj$/time/ZoneOffset;)Lj$/time/h;

    move-result-object p0

    new-instance p1, Lj$/time/ZonedDateTime;

    invoke-direct {p1, p0, v0, p3}, Lj$/time/ZonedDateTime;-><init>(Lj$/time/h;Lj$/time/ZoneOffset;Lj$/time/ZoneId;)V
...
.method public static j(Lj$/time/temporal/TemporalAccessor;)Lj$/time/ZonedDateTime;
    ...
    invoke-interface {p0, v1}, Lj$/time/temporal/TemporalAccessor;->i(Lj$/time/temporal/o;)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-interface {p0, v1}, Lj$/time/temporal/TemporalAccessor;->e(Lj$/time/temporal/o;)J

    move-result-wide v1

    sget-object v3, Lj$/time/temporal/a;->NANO_OF_SECOND:Lj$/time/temporal/a;

    invoke-interface {p0, v3}, Lj$/time/temporal/TemporalAccessor;->c(Lj$/time/temporal/o;)I

    move-result v3

    invoke-static {v1, v2, v3, v0}, Lj$/time/ZonedDateTime;->h(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    ...
    invoke-static {p0}, Lj$/time/j;->l(Lj$/time/temporal/TemporalAccessor;)Lj$/time/j;
    ...
    invoke-static {v1, v0, v2}, Lj$/time/ZonedDateTime;->n(Lj$/time/h;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/ZonedDateTime;
...
.method public static n(Lj$/time/h;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/ZonedDateTime;
    .locals 5
    ...
    invoke-direct {p2, p0, v0, p1}, Lj$/time/ZonedDateTime;-><init>(Lj$/time/h;Lj$/time/ZoneOffset;Lj$/time/ZoneId;)V
    ...
    invoke-virtual {v0, p0}, Lj$/time/zone/c;->g(Lj$/time/h;)Ljava/util/List;
    ...
    invoke-virtual {v0, p0}, Lj$/time/zone/c;->f(Lj$/time/h;)Lj$/time/zone/a;
    ...
    invoke-virtual {p0, v0, v1}, Lj$/time/h;->A(J)Lj$/time/h;
    ...
    invoke-direct {v0, p0, p2, p1}, Lj$/time/ZonedDateTime;-><init>(Lj$/time/h;Lj$/time/ZoneOffset;Lj$/time/ZoneId;)V
...
.method private o(Lj$/time/h;)Lj$/time/ZonedDateTime;
    .locals 2
    ...
    invoke-static {p1, v0, v1}, Lj$/time/ZonedDateTime;->n(Lj$/time/h;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/ZonedDateTime;
...
.method public static of(IIIIIIILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    ...
    invoke-static/range {p0 .. p6}, Lj$/time/h;->s(IIIIIII)Lj$/time/h;

    move-result-object p0

    const/4 p1, 0x0

    invoke-static {p0, p7, p1}, Lj$/time/ZonedDateTime;->n(Lj$/time/h;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/ZonedDateTime;
...
.method public static ofInstant(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    ...
    invoke-static {v0, v1, p0, p1}, Lj$/time/ZonedDateTime;->h(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
...
.method private p(Lj$/time/ZoneOffset;)Lj$/time/ZonedDateTime;
    ...
    iget-object v1, p0, Lj$/time/ZonedDateTime;->a:Lj$/time/h;

    invoke-virtual {v0, v1}, Lj$/time/zone/c;->g(Lj$/time/h;)Ljava/util/List;
    ...
    invoke-direct {v0, v1, p1, v2}, Lj$/time/ZonedDateTime;-><init>(Lj$/time/h;Lj$/time/ZoneOffset;Lj$/time/ZoneId;)V
...
.method public static parse(Ljava/lang/CharSequence;)Lj$/time/ZonedDateTime;
    ...
    sget-object v1, Lj$/time/q;->a:Lj$/time/q;

    invoke-virtual {v0, p0, v1}, Lj$/time/format/DateTimeFormatter;->e(Ljava/lang/CharSequence;Lj$/time/temporal/x;)Ljava/lang/Object;
...
.method public a(Lj$/time/temporal/l;)Lj$/time/temporal/k;
    ...
    iget-object v0, p0, Lj$/time/ZonedDateTime;->a:Lj$/time/h;

    invoke-virtual {v0}, Lj$/time/h;->G()Lj$/time/j;

    move-result-object v0

    invoke-static {p1, v0}, Lj$/time/h;->t(Lj$/time/LocalDate;Lj$/time/j;)Lj$/time/h;
...
.method public b(Lj$/time/temporal/o;J)Lj$/time/temporal/k;
    .locals 3
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/h;->J(Lj$/time/temporal/o;J)Lj$/time/h;

    move-result-object p1

    invoke-direct {p0, p1}, Lj$/time/ZonedDateTime;->o(Lj$/time/h;)Lj$/time/ZonedDateTime;
    ...
    :cond_1
    iget-object p1, p0, Lj$/time/ZonedDateTime;->a:Lj$/time/h;

    invoke-virtual {p1}, Lj$/time/h;->m()I

    move-result p1

    iget-object v0, p0, Lj$/time/ZonedDateTime;->c:Lj$/time/ZoneId;

    invoke-static {p2, p3, p1, v0}, Lj$/time/ZonedDateTime;->h(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
...
.method public compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0}, Lj$/time/ZonedDateTime;->t()Lj$/time/j;
    ...
    invoke-virtual {v0, v1}, Lj$/time/h;->j(Lj$/time/chrono/c;)I
...
.method public d(Lj$/time/temporal/o;)Lj$/time/temporal/A;
    ...
    invoke-virtual {v0, p1}, Lj$/time/h;->d(Lj$/time/temporal/o;)Lj$/time/temporal/A;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lj$/time/ZonedDateTime;->a:Lj$/time/h;
...
.method public f(JLj$/time/temporal/y;)Lj$/time/temporal/k;
    .locals 2
    ...
    invoke-interface {p3}, Lj$/time/temporal/y;->a()Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/h;->v(JLj$/time/temporal/y;)Lj$/time/h;
    ...
    invoke-virtual {v0, p1}, Lj$/time/zone/c;->g(Lj$/time/h;)Ljava/util/List;
    ...
    invoke-direct {v0, p1, p2, p3}, Lj$/time/ZonedDateTime;-><init>(Lj$/time/h;Lj$/time/ZoneOffset;Lj$/time/ZoneId;)V
    ...
    :cond_1
    invoke-virtual {p1, p2}, Lj$/time/h;->D(Lj$/time/ZoneOffset;)J
    ...
    invoke-static {v0, v1, p1, p3}, Lj$/time/ZonedDateTime;->h(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
...
.method public g(Lj$/time/temporal/x;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lj$/time/h;->E()Lj$/time/LocalDate;
...
.method public r()Lj$/time/chrono/b;
    ...
    invoke-virtual {v0}, Lj$/time/h;->E()Lj$/time/LocalDate;
