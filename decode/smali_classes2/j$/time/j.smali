...
.method private constructor <init>(Lj$/time/LocalDate;Lj$/time/l;)V
    ...
    iput-object p1, p0, Lj$/time/j;->a:Lj$/time/LocalDate;
...
.method private B(Lj$/time/LocalDate;JJJJI)Lj$/time/j;
    .locals 18
    ...
    :goto_0
    invoke-direct {v0, v1, v2}, Lj$/time/j;->H(Lj$/time/LocalDate;Lj$/time/l;)Lj$/time/j;
    ...
    invoke-virtual {v4}, Lj$/time/l;->w()J
    ...
    :cond_1
    invoke-static {v2, v3}, Lj$/time/l;->r(J)Lj$/time/l;
...
.method private H(Lj$/time/LocalDate;Lj$/time/l;)Lj$/time/j;
    .locals 1

    iget-object v0, p0, Lj$/time/j;->a:Lj$/time/LocalDate;
    ...
    invoke-direct {v0, p1, p2}, Lj$/time/j;-><init>(Lj$/time/LocalDate;Lj$/time/l;)V

    return-object v0
.end method

.method private k(Lj$/time/j;)I
    .locals 2

    iget-object v0, p0, Lj$/time/j;->a:Lj$/time/LocalDate;

    iget-object v1, p1, Lj$/time/j;->a:Lj$/time/LocalDate;
    ...
    invoke-virtual {v0, p1}, Lj$/time/l;->j(Lj$/time/l;)I
...
.method public static r(IIIII)Lj$/time/j;
    .locals 0
    ...
    invoke-static {p3, p4}, Lj$/time/l;->p(II)Lj$/time/l;

    move-result-object p1

    new-instance p2, Lj$/time/j;

    invoke-direct {p2, p0, p1}, Lj$/time/j;-><init>(Lj$/time/LocalDate;Lj$/time/l;)V

    return-object p2
.end method

.method public static s(IIIIIII)Lj$/time/j;
    .locals 0
    ...
    invoke-static {p3, p4, p5, p6}, Lj$/time/l;->q(IIII)Lj$/time/l;
...
.method public static t(Lj$/time/LocalDate;Lj$/time/l;)Lj$/time/j;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lj$/time/j;-><init>(Lj$/time/LocalDate;Lj$/time/l;)V

    return-object v0
.end method

.method public static u(JILj$/time/ZoneOffset;)Lj$/time/j;
    .locals 5
    ...
    invoke-direct {p2, p1, p0}, Lj$/time/j;-><init>(Lj$/time/LocalDate;Lj$/time/l;)V
...
# virtual methods
.method public A(J)Lj$/time/j;
    .locals 11

    iget-object v1, p0, Lj$/time/j;->a:Lj$/time/LocalDate;
    ...
    invoke-direct/range {v0 .. v10}, Lj$/time/j;->B(Lj$/time/LocalDate;JJJJI)Lj$/time/j;
...
.method public C(J)Lj$/time/j;
    ...
    invoke-direct {p0, p1, p2}, Lj$/time/j;->H(Lj$/time/LocalDate;Lj$/time/l;)Lj$/time/j;
...
.method public D(Lj$/time/ZoneOffset;)J
    ...
    invoke-virtual {p0}, Lj$/time/j;->G()Lj$/time/l;
...
.method public I(Lj$/time/temporal/l;)Lj$/time/j;
    .locals 1
    ...
    invoke-direct {p0, p1, v0}, Lj$/time/j;->H(Lj$/time/LocalDate;Lj$/time/l;)Lj$/time/j;
    ...
    invoke-direct {p0, v0, p1}, Lj$/time/j;->H(Lj$/time/LocalDate;Lj$/time/l;)Lj$/time/j;
...
.method public J(Lj$/time/temporal/o;J)Lj$/time/j;
    .locals 2
    ...
    invoke-virtual {v1, p1, p2, p3}, Lj$/time/l;->y(Lj$/time/temporal/o;J)Lj$/time/l;
...
.method public bridge synthetic b(Lj$/time/temporal/l;)Lj$/time/temporal/k;
    ...
    invoke-virtual {p0, p1}, Lj$/time/j;->I(Lj$/time/temporal/l;)Lj$/time/j;
...
.method public bridge synthetic c(Lj$/time/temporal/o;J)Lj$/time/temporal/k;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/j;->J(Lj$/time/temporal/o;J)Lj$/time/j;
...
.method public bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/j;->j(Lj$/time/chrono/c;)I
...
.method public d(Lj$/time/temporal/o;)I
    ...
    invoke-virtual {v0, p1}, Lj$/time/l;->d(Lj$/time/temporal/o;)I
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDate;->d(Lj$/time/temporal/o;)I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lj$/time/j;->a:Lj$/time/LocalDate;
...
.method public bridge synthetic h(JLj$/time/temporal/x;)Lj$/time/temporal/k;
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lj$/time/j;->v(JLj$/time/temporal/x;)Lj$/time/j;
...
.method public i(Lj$/time/temporal/w;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lj$/time/j;->a:Lj$/time/LocalDate;
    ...
    invoke-virtual {p0}, Lj$/time/j;->l()Lj$/time/chrono/g;
...
.method public j(Lj$/time/chrono/c;)I
    ...
    invoke-direct {p0, p1}, Lj$/time/j;->k(Lj$/time/j;)I
    ...
    invoke-virtual {p1}, Lj$/time/j;->F()Lj$/time/chrono/b;
    ...
    invoke-virtual {p1}, Lj$/time/j;->G()Lj$/time/l;

    move-result-object v1

    invoke-virtual {v0, v1}, Lj$/time/l;->j(Lj$/time/l;)I
    ...
    invoke-virtual {p1}, Lj$/time/j;->l()Lj$/time/chrono/g;
...
.method public p(Lj$/time/chrono/c;)Z
    ...
    invoke-virtual {v0}, Lj$/time/l;->w()J
    ...
    invoke-virtual {p1}, Lj$/time/l;->w()J
...
.method public v(JLj$/time/temporal/x;)Lj$/time/j;
    .locals 11
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/LocalDate;->v(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    invoke-virtual {p0, v2, v3}, Lj$/time/j;->w(J)Lj$/time/j;
    ...
    invoke-virtual {p3, p1, p2}, Lj$/time/j;->x(J)Lj$/time/j;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p2}, Lj$/time/j;->A(J)Lj$/time/j;
    ...
    invoke-virtual {p3, p1, p2}, Lj$/time/j;->z(J)Lj$/time/j;
