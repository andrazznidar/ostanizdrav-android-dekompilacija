...
.method c1(Lj$/util/stream/D0;Lj$/util/Spliterator;Lj$/util/function/p;)Lj$/util/stream/P0;
    ...
    invoke-virtual {p1, p2, v1, p3}, Lj$/util/stream/D0;->t0(Lj$/util/Spliterator;ZLj$/util/function/p;)Lj$/util/stream/P0;
    ...
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/s;->j1(Lj$/util/stream/D0;Lj$/util/Spliterator;)Lj$/util/stream/P0;
    ...
    invoke-direct {v2, p3, v0, v1}, Lj$/util/stream/o;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance v3, Lj$/util/stream/Y;

    invoke-direct {v3, v2, v1}, Lj$/util/stream/Y;-><init>(Lj$/util/function/Consumer;Z)V

    invoke-virtual {v3, p1, p2}, Lj$/util/stream/Z;->e(Lj$/util/stream/D0;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method d1(Lj$/util/stream/D0;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-virtual {p1, p2}, Lj$/util/stream/D0;->U0(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-virtual {p1}, Lj$/util/stream/T0;->spliterator()Lj$/util/Spliterator;
...
.method f1(ILj$/util/stream/q2;)Lj$/util/stream/q2;
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/q;-><init>(Lj$/util/stream/s;Lj$/util/stream/q2;)V
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/r;-><init>(Lj$/util/stream/s;Lj$/util/stream/q2;)V

    return-object p1
.end method

.method j1(Lj$/util/stream/D0;Lj$/util/Spliterator;)Lj$/util/stream/P0;
    .locals 3
    ...
    invoke-static {v0, v1, v2}, Lj$/util/stream/D0;->P0(Lj$/util/function/C;Lj$/util/function/BiConsumer;Lj$/util/function/BiConsumer;)Lj$/util/stream/M3;

    move-result-object v0

    check-cast v0, Lj$/util/stream/a2;

    invoke-virtual {v0, p1, p2}, Lj$/util/stream/a2;->e(Lj$/util/stream/D0;Lj$/util/Spliterator;)Ljava/lang/Object;
