...
.method constructor <init>(Lj$/util/stream/c;Lj$/util/stream/g4;IJJ)V
    ...
    iput-wide p4, p0, Lj$/util/stream/t3;->l:J

    iput-wide p6, p0, Lj$/util/stream/t3;->m:J

    invoke-direct {p0, p1, p2, p3}, Lj$/util/stream/J0;-><init>(Lj$/util/stream/c;Lj$/util/stream/g4;I)V
...
.method B0(Lj$/util/stream/z2;Lj$/util/Spliterator;Lj$/util/function/j;)Lj$/util/stream/B1;
    ...
    iget-wide v12, v9, Lj$/util/stream/t3;->l:J

    iget-wide v14, v9, Lj$/util/stream/t3;->m:J
    ...
    invoke-static {v2, v0, v8}, Lj$/util/stream/y2;->g(Lj$/util/stream/z2;Lj$/util/Spliterator;Z)Lj$/util/stream/x1;
    ...
    iget-wide v2, v9, Lj$/util/stream/t3;->l:J

    iget-wide v4, v9, Lj$/util/stream/t3;->m:J

    move-object/from16 v0, p0

    invoke-virtual/range {v0 .. v7}, Lj$/util/stream/t3;->K0(Lj$/util/Spliterator$b;JJJ)Lj$/util/Spliterator$b;

    move-result-object v0

    invoke-static {v9, v0, v8}, Lj$/util/stream/y2;->g(Lj$/util/stream/z2;Lj$/util/Spliterator;Z)Lj$/util/stream/x1;
    ...
    iget-wide v5, v9, Lj$/util/stream/t3;->l:J

    iget-wide v7, v9, Lj$/util/stream/t3;->m:J
...
.method C0(Lj$/util/stream/z2;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget-wide v1, v9, Lj$/util/stream/t3;->m:J
    ...
    invoke-direct/range {v10 .. v15}, Lj$/util/stream/y4;-><init>(Lj$/util/Spliterator$b;JJ)V
    ...
    sget-object v4, Lj$/util/stream/r3;->a:Lj$/util/stream/r3;
...
.method E0(ILj$/util/stream/n3;)Lj$/util/stream/n3;
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/s3;-><init>(Lj$/util/stream/t3;Lj$/util/stream/n3;)V
...
.method K0(Lj$/util/Spliterator$b;JJJ)Lj$/util/Spliterator$b;
    ...
    invoke-direct/range {p2 .. p7}, Lj$/util/stream/H4;-><init>(Lj$/util/Spliterator$b;JJ)V
