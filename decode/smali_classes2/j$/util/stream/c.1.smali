...
.method constructor <init>(Lj$/util/stream/c;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/f4;->a(II)I
    ...
    invoke-virtual {p0}, Lj$/util/stream/c;->D0()Z
...
.method private F0(I)Lj$/util/Spliterator;
    ...
    invoke-virtual {v2}, Lj$/util/stream/c;->D0()Z
    ...
    sget-object v5, Lj$/util/stream/f4;->SHORT_CIRCUIT:Lj$/util/stream/f4;

    invoke-virtual {v5, v4}, Lj$/util/stream/f4;->d(I)Z

    move-result v5

    if-eqz v5, :cond_0

    sget v5, Lj$/util/stream/f4;->u:I
    ...
    :cond_0
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/c;->C0(Lj$/util/stream/z2;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    sget v5, Lj$/util/stream/f4;->t:I

    not-int v5, v5

    and-int/2addr v4, v5

    sget v5, Lj$/util/stream/f4;->s:I
    ...
    invoke-static {v4, v0}, Lj$/util/stream/f4;->a(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/f4;->a(II)I
...
.method public synthetic A0()Lj$/util/Spliterator;
    ...
    invoke-direct {p0, v0}, Lj$/util/stream/c;->F0(I)Lj$/util/Spliterator;
...
.method C0(Lj$/util/stream/z2;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/c;->B0(Lj$/util/stream/z2;Lj$/util/Spliterator;Lj$/util/function/j;)Lj$/util/stream/B1;

    move-result-object p1

    invoke-interface {p1}, Lj$/util/stream/B1;->spliterator()Lj$/util/Spliterator;
...
.method abstract E0(ILj$/util/stream/n3;)Lj$/util/stream/n3;
.end method
...
.method abstract H0(Lj$/util/stream/z2;Lj$/util/function/t;Z)Lj$/util/Spliterator;
.end method
...
.method final k0(Lj$/util/stream/n3;Lj$/util/Spliterator;)V
    .locals 2

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Lj$/util/stream/f4;->SHORT_CIRCUIT:Lj$/util/stream/f4;
    ...
    invoke-interface {p1}, Lj$/util/stream/n3;->w()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/c;->l0(Lj$/util/stream/n3;Lj$/util/Spliterator;)V

    :goto_0
    return-void
.end method

.method final l0(Lj$/util/stream/n3;Lj$/util/Spliterator;)V
    .locals 3
    ...
    invoke-virtual {v0, p2, p1}, Lj$/util/stream/c;->x0(Lj$/util/Spliterator;Lj$/util/stream/n3;)V
...
.method final m0(Lj$/util/Spliterator;ZLj$/util/function/j;)Lj$/util/stream/B1;
    .locals 2
    ...
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/c;->w0(Lj$/util/stream/z2;Lj$/util/Spliterator;ZLj$/util/function/j;)Lj$/util/stream/B1;
    ...
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/z2;->q0(JLj$/util/function/j;)Lj$/util/stream/t1;

    move-result-object p2

    invoke-static {p2}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {p0, p2}, Lj$/util/stream/c;->s0(Lj$/util/stream/n3;)Lj$/util/stream/n3;

    move-result-object p3

    invoke-virtual {p0, p3, p1}, Lj$/util/stream/c;->k0(Lj$/util/stream/n3;Lj$/util/Spliterator;)V

    invoke-interface {p2}, Lj$/util/stream/t1;->a()Lj$/util/stream/B1;
...
.method final o0()Lj$/util/stream/g4;
    .locals 2
    ...
    :cond_0
    invoke-virtual {v0}, Lj$/util/stream/c;->y0()Lj$/util/stream/g4;
...
.method public onClose(Ljava/lang/Runnable;)Lj$/util/stream/g;
    ...
    invoke-direct {v2, v1, p1}, Lj$/util/stream/O4;-><init>(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method final r0(Lj$/util/stream/n3;Lj$/util/Spliterator;)Lj$/util/stream/n3;
    .locals 1

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {p0, p1}, Lj$/util/stream/c;->s0(Lj$/util/stream/n3;)Lj$/util/stream/n3;

    move-result-object v0

    invoke-virtual {p0, v0, p2}, Lj$/util/stream/c;->k0(Lj$/util/stream/n3;Lj$/util/Spliterator;)V

    return-object p1
.end method

.method final s0(Lj$/util/stream/n3;)Lj$/util/stream/n3;
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Lj$/util/stream/c;->E0(ILj$/util/stream/n3;)Lj$/util/stream/n3;
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    invoke-virtual {p0, p0, v1, v0}, Lj$/util/stream/c;->H0(Lj$/util/stream/z2;Lj$/util/function/t;Z)Lj$/util/Spliterator;
...
.method final t0(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/c;->H0(Lj$/util/stream/z2;Lj$/util/function/t;Z)Lj$/util/Spliterator;
...
.method final u0(Lj$/util/stream/P4;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-interface {p1}, Lj$/util/stream/P4;->b()I
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/P4;->f(Lj$/util/stream/z2;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/P4;->g(Lj$/util/stream/z2;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method final v0(Lj$/util/function/j;)Lj$/util/stream/B1;
    .locals 3
    ...
    invoke-direct {v0, v2}, Lj$/util/stream/c;->F0(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v0, v1, p1}, Lj$/util/stream/c;->B0(Lj$/util/stream/z2;Lj$/util/Spliterator;Lj$/util/function/j;)Lj$/util/stream/B1;
    ...
    :cond_0
    invoke-direct {p0, v2}, Lj$/util/stream/c;->F0(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/c;->m0(Lj$/util/Spliterator;ZLj$/util/function/j;)Lj$/util/stream/B1;
...
.method abstract w0(Lj$/util/stream/z2;Lj$/util/Spliterator;ZLj$/util/function/j;)Lj$/util/stream/B1;
.end method

.method abstract x0(Lj$/util/Spliterator;Lj$/util/stream/n3;)V
.end method

.method abstract y0()Lj$/util/stream/g4;
.end method
