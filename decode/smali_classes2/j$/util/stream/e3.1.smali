...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lj$/util/stream/d3;->SPLITERATOR:Lj$/util/stream/d3;

    invoke-static {v1}, Lj$/util/stream/e3;->f(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    move-result-object v2

    sget-object v3, Lj$/util/stream/d3;->STREAM:Lj$/util/stream/d3;

    invoke-virtual {v2, v3}, Lj$/util/stream/c3;->b(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    sget-object v4, Lj$/util/stream/d3;->OP:Lj$/util/stream/d3;

    invoke-virtual {v2, v4}, Lj$/util/stream/c3;->c(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    const-string v5, "DISTINCT"

    const/4 v6, 0x0

    invoke-direct {v0, v5, v6, v6, v2}, Lj$/util/stream/e3;-><init>(Ljava/lang/String;IILj$/util/stream/c3;)V

    sput-object v0, Lj$/util/stream/e3;->DISTINCT:Lj$/util/stream/e3;

    new-instance v2, Lj$/util/stream/e3;

    invoke-static {v1}, Lj$/util/stream/e3;->f(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    move-result-object v5

    invoke-virtual {v5, v3}, Lj$/util/stream/c3;->b(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    invoke-virtual {v5, v4}, Lj$/util/stream/c3;->c(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    const-string v7, "SORTED"

    const/4 v8, 0x1

    invoke-direct {v2, v7, v8, v8, v5}, Lj$/util/stream/e3;-><init>(Ljava/lang/String;IILj$/util/stream/c3;)V

    sput-object v2, Lj$/util/stream/e3;->SORTED:Lj$/util/stream/e3;
    ...
    invoke-virtual {v7, v3}, Lj$/util/stream/c3;->b(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    invoke-virtual {v7, v4}, Lj$/util/stream/c3;->c(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    sget-object v9, Lj$/util/stream/d3;->TERMINAL_OP:Lj$/util/stream/d3;

    invoke-virtual {v7, v9}, Lj$/util/stream/c3;->a(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    sget-object v10, Lj$/util/stream/d3;->UPSTREAM_TERMINAL_OP:Lj$/util/stream/d3;

    invoke-virtual {v7, v10}, Lj$/util/stream/c3;->a(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    const-string v11, "ORDERED"

    const/4 v12, 0x2

    invoke-direct {v5, v11, v12, v12, v7}, Lj$/util/stream/e3;-><init>(Ljava/lang/String;IILj$/util/stream/c3;)V

    sput-object v5, Lj$/util/stream/e3;->ORDERED:Lj$/util/stream/e3;
    ...
    invoke-virtual {v11, v3}, Lj$/util/stream/c3;->b(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    invoke-virtual {v11, v4}, Lj$/util/stream/c3;->a(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    const-string v13, "SIZED"

    const/4 v14, 0x3

    invoke-direct {v7, v13, v14, v14, v11}, Lj$/util/stream/e3;-><init>(Ljava/lang/String;IILj$/util/stream/c3;)V

    sput-object v7, Lj$/util/stream/e3;->SIZED:Lj$/util/stream/e3;

    new-instance v11, Lj$/util/stream/e3;

    invoke-static {v4}, Lj$/util/stream/e3;->f(Lj$/util/stream/d3;)Lj$/util/stream/c3;

    move-result-object v13

    invoke-virtual {v13, v9}, Lj$/util/stream/c3;->b(Lj$/util/stream/d3;)Lj$/util/stream/c3;
    ...
    invoke-direct {v11, v15, v14, v12, v13}, Lj$/util/stream/e3;-><init>(Ljava/lang/String;IILj$/util/stream/c3;)V

    sput-object v11, Lj$/util/stream/e3;->SHORT_CIRCUIT:Lj$/util/stream/e3;

    const/4 v12, 0x5

    new-array v12, v12, [Lj$/util/stream/e3;
    ...
    sput-object v12, Lj$/util/stream/e3;->v:[Lj$/util/stream/e3;

    invoke-static {v1}, Lj$/util/stream/e3;->b(Lj$/util/stream/d3;)I

    move-result v0

    sput v0, Lj$/util/stream/e3;->f:I

    invoke-static {v3}, Lj$/util/stream/e3;->b(Lj$/util/stream/d3;)I

    move-result v0

    sput v0, Lj$/util/stream/e3;->g:I

    invoke-static {v4}, Lj$/util/stream/e3;->b(Lj$/util/stream/d3;)I
    ...
    invoke-static {v10}, Lj$/util/stream/e3;->b(Lj$/util/stream/d3;)I
...
.method private constructor <init>(Ljava/lang/String;IILj$/util/stream/c3;)V
    ...
    iget-object v3, p4, Lj$/util/stream/c3;->a:Ljava/util/Map;
    ...
    :cond_1
    iget-object p1, p4, Lj$/util/stream/c3;->a:Ljava/util/Map;
...
.method private static b(Lj$/util/stream/d3;)I
    ...
    iget-object v5, v4, Lj$/util/stream/e3;->a:Ljava/util/Map;
...
.method private static f(Lj$/util/stream/d3;)Lj$/util/stream/c3;
    ...
    invoke-direct {v0, v1}, Lj$/util/stream/c3;-><init>(Ljava/util/Map;)V
